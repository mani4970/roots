...
export const NEHEMIAH_WALL_STAGES: readonly NehemiahWallStage[] = [
  ...
  { stageNumber: 4, startDay: 16, endDay: 18, label: "등불을 들고 성벽을 따라 이동", action: "lanternWalkThrough" },
  ...
  { stageNumber: 10, startDay: 70, endDay: 70, label: "완성된 성벽 앞에서 인사", action: "wave" },
