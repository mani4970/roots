...
export const T = {
  ...
  login_google_btn:   { ko: "Google로 계속하기",          de: "Mit Google fortfahren", en: "Mit Google fortfahren" },
  login_or_email:     { ko: "또는 이메일로",             de: "oder per E-Mail", en: "oder per E-Mail" },
  ...
  login_loading:      { ko: "로그인 중...",              de: "Wird angemeldet...", en: "Wird angemeldet..." },
  login_error:        { ko: "이메일 또는 비밀번호가 틀렸어요", de: "E-Mail oder Passwort ist falsch", en: "Login failed. Please check your credentials." },
  login_no_account:   { ko: "계정이 없으신가요?",         de: "Noch kein Konto?", en: "Noch kein Konto?" },
  login_signup_link:  { ko: "회원가입",                  de: "Registrieren", en: "Sign up" },

  signup_title:       { ko: "시작하기",                 de: "Loslegen", en: "Join Roots 🌱" },
  signup_sub:         { ko: "오늘부터 말씀에 뿌리내려요 🌱", de: "Ab heute in Gottes Wort verwurzeln 🌱", en: "Ab heute in Gottes Wort verwurzeln 🌱" },
  signup_nickname:    { ko: "닉네임",                   de: "Nickname", en: "Nickname" },
  signup_nickname_ph: { ko: "사용하실 닉네임을 입력해주세요", de: "Geben Sie einen Nickname ein", en: "Geben Sie einen Nickname ein" },
  signup_password:    { ko: "비밀번호 (6자 이상)",        de: "Passwort (mind. 6 Zeichen)", en: "Passwort (mind. 6 Zeichen)" },
  signup_btn:         { ko: "시작하기",                 de: "Loslegen", en: "Sign up" },
  signup_loading:     { ko: "가입 중...",               de: "Wird registriert...", en: "Wird registriert..." },
  ...
  signup_pw_error:    { ko: "비밀번호는 6자 이상이어야 해요", de: "Passwort muss mindestens 6 Zeichen haben", en: "Passwort muss mindestens 6 Zeichen haben" },
  signup_back:        { ko: "로그인으로",               de: "Zurück zur Anmeldung", en: "Zurück zur Anmeldung" },

  // ── 공통 ──
  save:     { ko: "저장",    de: "Speichern", en: "Save" },
  cancel:   { ko: "취소",    de: "Abbrechen", en: "Cancel" },
  close:    { ko: "닫기",    de: "Schließen", en: "Schließen" },
  delete:   { ko: "삭제",    de: "Löschen", en: "Delete" },
  edit:     { ko: "수정",    de: "Bearbeiten", en: "Bearbeiten" },
  confirm:  { ko: "확인",    de: "Bestätigen", en: "Bestätigen" },
  loading:  { ko: "로딩 중...", de: "Lädt...", en: "Lädt..." },
  ...
  home_greeting_night:    { ko: "좋은 밤이에요 🌙",     de: "Gute Nacht 🌙", en: "Gute Nacht 🌙" },
  home_verse_section:     { ko: "오늘의 말씀",          de: "Tagesvers", en: "Today's verse" },
  home_verse_empty:       { ko: "오늘의 감정을 선택하면 맞춤 말씀을 받을 수 있어요 🌿", de: "Wählen Sie Ihre Stimmung und erhalten Sie einen passenden Vers 🌿", en: "Wählen Sie Ihre Stimmung und erhalten Sie einen passenden Vers 🌿" },
  home_verse_btn:         { ko: "오늘의 말씀 받기",     de: "Tagesvers erhalten", en: "Get today's verse" },
  home_recommend_section: { ko: "오늘의 추천 결단",     de: "Empfohlener Vorsatz", en: "Empfohlener Vorsatz" },
  home_decision_practiced:{ ko: "결단 실천 완료! 🎉",    de: "Vorsatz umgesetzt! 🎉", en: "Vorsatz umgesetzt! 🎉" },
  home_decision_practice: { ko: "오늘 이 결단을 실천했어요", de: "Ich habe diesen Vorsatz umgesetzt", en: "Ich habe diesen Vorsatz umgesetzt" },
  home_my_decision:       { ko: "오늘 나의 결단",       de: "Meine heutigen Vorsätze", en: "Meine heutigen Vorsätze" },
  home_prayer_section:    { ko: "오늘의 기도",          de: "Heutiges Gebet", en: "Today's Prayer" },
  home_prayer_desc:       { ko: "오늘 잠깐이라도 기도를 통해 하나님과 인격적인 만남을 하셨나요?", de: "Haben Sie heute, wenn auch nur kurz, im Gebet eine persönliche Begegnung mit Gott gehabt?", en: "Haben Sie heute, wenn auch nur kurz, im Gebet eine persönliche Begegnung mit Gott gehabt?" },
  home_prayer_done_msg:   { ko: "기도 완료! 🙏",        de: "Gebetet! 🙏", en: "Prayed! 🙏" },
  home_prayer_yes_btn:    { ko: "네, 오늘 기도했어요",    de: "Ja, ich habe heute gebetet", en: "Ja, ich habe heute gebetet" },
  ...
  home_routine_notdone:   { ko: "미완료",               de: "Offen", en: "Offen" },
  ...
  tree_desc_0:   { ko: "겨자씨가 땅에 심겨졌어요",       de: "Ein Senfkorn wurde gesät", en: "Ein Senfkorn wurde gesät" },
  tree_desc_1:   { ko: "겨자씨가 땅에 심겨졌어요",       de: "Ein Senfkorn wurde gesät", en: "Ein Senfkorn wurde gesät" },
  tree_desc_2:   { ko: "고개를 들고 햇빛을 찾아요",     de: "Es streckt sich zum Licht", en: "Es streckt sich zum Licht" },
  tree_desc_3:   { ko: "뿌리를 단단히 내리고 있어요",    de: "Die Wurzeln greifen tief", en: "Die Wurzeln greifen tief" },
  tree_desc_4:   { ko: "가지가 뻗어나가고 있어요",      de: "Die Äste breiten sich aus", en: "Die Äste breiten sich aus" },
  tree_desc_5:   { ko: "든든하게 자라나고 있어요",       de: "Kräftig wächst er heran", en: "Kräftig wächst er heran" },
  tree_desc_6:   { ko: "새들이 날아와 깃들었어요",       de: "Vögel nisten in den Zweigen", en: "Vögel nisten in den Zweigen" },
  tree_desc_7:   { ko: "새 씨앗이 뿌려졌어요",          de: "Neue Samen wurden gesät", en: "Neue Samen wurden gesät" },
  tree_desc_8:   { ko: "이웃 나무가 자라고 있어요",      de: "Nachbarbäume wachsen", en: "Nachbarbäume wachsen" },
  tree_desc_9:   { ko: "아름다운 정원이 완성됐어요!",    de: "Ein wunderschöner Garten!", en: "Ein wunderschöner Garten!" },
  tree_desc_10:  { ko: "열매가 가득한 정원이에요!",      de: "Ein Garten voller Früchte!", en: "Ein Garten voller Früchte!" },
  ...
  tree_sub_1:   { ko: "씨앗이 땅속에서 뿌리를 내리기 시작했어요!",  de: "Der Samen beginnt, Wurzeln zu schlagen!", en: "Der Samen beginnt, Wurzeln zu schlagen!" },
  tree_sub_14:  { ko: "씨앗이 조금씩 움트고 있어요!",              de: "Der Samen keimt langsam!", en: "Der Samen keimt langsam!" },
  tree_sub_29:  { ko: "새싹이 햇빛을 향해 자라고 있어요!",         de: "Der Sprössling wächst zum Licht!", en: "Der Sprössling wächst zum Licht!" },
  tree_sub_59:  { ko: "묘목이 점점 단단해지고 있어요!",            de: "Der Setzling wird immer stärker!", en: "Der Setzling wird immer stärker!" },
  tree_sub_79:  { ko: "나무가 무럭무럭 자라고 있어요!",            de: "Der Baum wächst kräftig!", en: "Der Baum wächst kräftig!" },
  tree_sub_99:  { ko: "나무가 점점 더 자라고 있어요!",             de: "Der Baum wächst und wächst!", en: "Der Baum wächst und wächst!" },
  tree_sub_129: { ko: "열매를 맺은 나무처럼 풍성해지고 있어요!",    de: "Wie ein fruchtbarer Baum – immer üppiger!", en: "Wie ein fruchtbarer Baum – immer üppiger!" },
  tree_sub_max: { ko: "아름다운 정원이 완성되어 가고 있어요!",     de: "Ein wunderschöner Garten entsteht!", en: "Ein wunderschöner Garten entsteht!" },

  // ── RootsManPopup ──
  rootsman_title: { ko: "농부가 물을 주고 있어요",     de: "Der Gärtner gießt die Pflanzen", en: "Der Gärtner gießt die Pflanzen" },
  rootsman_check: { ko: "정원을 확인해보세요 🌱",       de: "Schauen Sie sich den Garten an 🌱", en: "Schauen Sie sich den Garten an 🌱" },
  rootsman_btn:   { ko: "정원 보러 가기",              de: "Zum Garten", en: "Zum Garten" },
  ...
  qt_sunday_desc:       { ko: "6단계 큐티 대신 주일예배 큐티를 진행해 주세요.", de: "Bitte die Sonntagsgottesdienst-QT durchführen.", en: "Bitte die Sonntagsgottesdienst-QT durchführen." },
  qt_today_start:       { ko: "오늘 큐티 시작하기",                   de: "Heutige QT beginnen", en: "Heutige QT beginnen" },
  qt_past_records:      { ko: "지난 큐티 기록",                       de: "Frühere QTs", en: "Recordings" },
  qt_no_records_simple: { ko: "아직 큐티 기록이 없어요",               de: "Noch keine Aufzeichnungen", en: "Noch keine Aufzeichnungen" },
  qt_how_title:         { ko: "어떻게 큐티할까요?",                    de: "Wie möchten Sie QT machen?", en: "Wie möchten Sie QT machen?" },
  qt_how_sub:           { ko: "형식을 선택하면 바로 시작돼요",         de: "Wählen Sie ein Format", en: "Wählen Sie ein Format" },
  qt_mode_6step_title:  { ko: "6단계 큐티",                           de: "6-Schritte QT", en: "6-Schritte QT" },
  qt_mode_6step_desc:   { ko: "들어가는 기도 → 본문 → 붙잡은 말씀\n→ 묵상 → 결단 → 마침 기도", de: "Eröffnungsgebet → Text → Schlüsselvers\n→ Meditation → Entschluss → Abschlussgebet", en: "Eröffnungsgebet → Text → Schlüsselvers\n→ Meditation → Entschluss → Abschlussgebet" },
  qt_mode_sunday_title: { ko: "주일예배 큐티",                        de: "Sonntagsgottesdienst", en: "Sunday Worship" },
  qt_mode_sunday_desc:  { ko: "설교 요약 + 붙잡은 말씀 + 결단\n일요일에 자동으로 추천돼요", de: "Predigtzusammenfassung + Schlüsselvers + Entschluss\nSonntags automatisch empfohlen", en: "Predigtzusammenfassung + Schlüsselvers + Entschluss\nSonntags automatisch empfohlen" },
  qt_mode_free_title:   { ko: "자유 형식",                           de: "Freie Form", en: "Freie Form" },
  qt_mode_free_desc:    { ko: "다른 큐티책을 쓰거나 자유롭게\n묵상을 적고 싶을 때", de: "Wenn Sie ein eigenes Andachtsbuch verwenden\noder frei meditieren möchten", en: "Wenn Sie ein eigenes Andachtsbuch verwenden\noder frei meditieren möchten" },
  qt_guide_btn:         { ko: "큐티 6단계 가이드 보기",                de: "6-Schritte-Anleitung ansehen", en: "6-Schritte-Anleitung ansehen" },
  qt_guide_step_label:  { ko: "큐티 가이드",                          de: "Anleitung", en: "Anleitung" },
  qt_guide_example:     { ko: "예시",                                de: "Beispiel", en: "Beispiel" },
  qt_guide_prev:        { ko: "← 이전",                              de: "← Zurück", en: "← Zurück" },
  qt_guide_next:        { ko: "다음 →",                              de: "Weiter →", en: "Weiter →" },
  qt_guide_start:       { ko: "시작하기 🌱",                         de: "Loslegen 🌱", en: "Loslegen 🌱" },
  ...
  qt_g1_desc:  { ko: "하나님께 나아가기 위한 접속 스위치. 스위치 ON 하면 하나님의 빛과 생명 에너지가 우리에게 흘러들어오기 시작!", de: "Der Startschalter, um zu Gott zu kommen. Wenn der Schalter an ist, beginnen Gottes Licht und Lebenskraft in uns zu fließen!", en: "Der Startschalter, um zu Gott zu kommen. Wenn der Schalter an ist, beginnen Gottes Licht und Lebenskraft in uns zu fließen!" },
  qt_g1_ex:    { ko: "주님, 제 눈을 열어 주님의 말씀을 보게 해 주세요. 제 귀를 열어 듣게 해 주세요. 제 마음을 열어 말씀을 받게 해 주세요. 예수님의 이름으로 기도합니다. 아멘", de: "Herr, öffne meine Augen, damit ich dein Wort sehe. Öffne meine Ohren, damit ich höre. Öffne mein Herz, damit ich dein Wort empfange. Im Namen Jesu, Amen.", en: "Herr, öffne meine Augen, damit ich dein Wort sehe. Öffne meine Ohren, damit ich höre. Öffne mein Herz, damit ich dein Wort empfange. Im Namen Jesu, Amen." },
  qt_g2_title: { ko: "본문 요약",         de: "Textzusammenfassung", en: "Textzusammenfassung" },
  qt_g2_desc:  { ko: "두 번 정도 반복해서 읽고 그 내용을 자신의 말로, 자신의 표현으로 요약!", de: "Lesen Sie den Text zweimal und fassen Sie ihn in eigenen Worten zusammen!", en: "Lesen Sie den Text zweimal und fassen Sie ihn in eigenen Worten zusammen!" },
  qt_g2_ex:    { ko: "예) 바울이 빌립보 교인들에게 어떤 상황에서도 기뻐하라고 권면하며, 걱정 대신 기도로 하나님께 아뢰면 평강이 임한다고 말한다.", de: "z. B. Paulus ermahnt die Philipper, sich in allen Umständen zu freuen, und sagt: Wer statt sich zu sorgen betet, empfängt Gottes Frieden.", en: "z. B. Paulus ermahnt die Philipper, sich in allen Umständen zu freuen, und sagt: Wer statt sich zu sorgen betet, empfängt Gottes Frieden." },
  qt_g3_title: { ko: "붙잡은 말씀",       de: "Schlüsselvers", en: "Schlüsselvers" },
  qt_g3_desc:  { ko: "말씀을 읽을 때, 말씀이 우리를 스캔합니다. 우리 마음 밭에 뿌려질 말씀의 씨앗이 있는 부분에서 멈춥니다. 그곳을 붙잡으면 됩니다.", de: "Beim Lesen scannt das Wort uns. Es hält dort an, wo der Same für unser Herz liegt. Dort halten wir fest.", en: "Beim Lesen scannt das Wort uns. Es hält dort an, wo der Same für unser Herz liegt. Dort halten wir fest." },
  ...
  qt_g4_desc:  { ko: "말씀은 살아계신 생명의 주로부터 옵니다. 철저하게 개인적으로, 맞춤형으로 옵니다. 물음표가 아닌 느낌표를 두고, 순종의 마음을 품고 성령님의 이끄심에 맡겨봅시다!", de: "Das Wort kommt vom lebendigen Herrn des Lebens. Es kommt ganz persönlich, maßgeschneidert. Setzen Sie Ausrufezeichen statt Fragezeichen, seien Sie gehorsam und lassen Sie sich vom Heiligen Geist leiten!", en: "Das Wort kommt vom lebendigen Herrn des Lebens. Es kommt ganz persönlich, maßgeschneidert. Setzen Sie Ausrufezeichen statt Fragezeichen, seien Sie gehorsam und lassen Sie sich vom Heiligen Geist leiten!" },
  qt_g4_ex:    { ko: "예) 요즘 취업 걱정에 잠 못 드는데, 주님이 오늘 이 말씀으로 '나한테 가져와'라고 하시는 것 같았다.", de: "z. B. Ich kann vor Jobsorgen nicht schlafen, und heute sagt der Herr mir durch dieses Wort: 'Bring es zu mir.'", en: "z. B. Ich kann vor Jobsorgen nicht schlafen, und heute sagt der Herr mir durch dieses Wort: 'Bring es zu mir.'" },
  qt_g5_title: { ko: "적용과 결단",       de: "Anwendung & Entschluss", en: "Application & Resolution" },
  qt_g5_desc:  { ko: "적용과 결단은 말씀이 나의 성품이 되는 가장 중요한 단계. 성품은 마음을 정하는 것이고, 행동은 손과 발로 하나님의 능력이 드러나게 하는 것입니다.", de: "Anwendung und Entschluss sind der wichtigste Schritt, damit das Wort zu meinem Charakter wird. Charakter ist die Entscheidung des Herzens, Handlung zeigt Gottes Kraft mit Händen und Füßen.", en: "Anwendung und Entschluss sind der wichtigste Schritt, damit das Wort zu meinem Charakter wird. Charakter ist die Entscheidung des Herzens, Handlung zeigt Gottes Kraft mit Händen und Füßen." },
  qt_g5_ex:    { ko: "성품: 모든 일에 먼저 기도하고 긍정적으로 생각하겠습니다.\n행동: 주신 말씀 친구들과 나누기 / 자기 전에 기도하기", de: "Charakter: Ich werde bei allem zuerst beten und positiv denken.\nHandlung: Das Wort mit Freunden teilen / Vor dem Schlafen beten", en: "Charakter: Ich werde bei allem zuerst beten und positiv denken.\nHandlung: Das Wort mit Freunden teilen / Vor dem Schlafen beten" },
  qt_g6_title: { ko: "올려드리는 기도",    de: "Abschlussgebet", en: "Closing Prayer" },
  qt_g6_desc:  { ko: "주신 말씀과 받은 은혜에 대한 감사와 영광을, 묵상과 결단을 간결하게 다시 하나님께 올려드립니다.", de: "Danken Sie Gott für das empfangene Wort und die Gnade, und bringen Sie Meditation und Entschluss kurz vor Gott.", en: "Danken Sie Gott für das empfangene Wort und die Gnade, und bringen Sie Meditation und Entschluss kurz vor Gott." },
  qt_g6_ex:    { ko: "예) 주님, 오늘 염려를 기도로 바꾸라는 말씀 감사해요. 오늘 하루 말씀대로 살게 도와주세요. 예수님 이름으로 기도합니다. 아멘", de: "z. B. Herr, danke für das Wort, Sorgen in Gebet zu verwandeln. Hilf mir heute, nach deinem Wort zu leben. Im Namen Jesu, Amen.", en: "z. B. Herr, danke für das Wort, Sorgen in Gebet zu verwandeln. Hilf mir heute, nach deinem Wort zu leben. Im Namen Jesu, Amen." },

  // ── 언어 선택 화면 ──
  lang_picker_title: { ko: "언어를 선택해주세요",     de: "Sprache wählen", en: "Sprache wählen" },
  ...
  // ── QT record ──
  qt_record_all:        { ko: "전체 커뮤니티", de: "Gesamte Gemeinde", en: "Gesamte Gemeinde" },
  qt_record_copied:     { ko: "복사됨! ✓",    de: "Kopiert! ✓", en: "Kopiert! ✓" },
  qt_record_copy_all:   { ko: "전체 복사",     de: "Alles kopieren", en: "Alles kopieren" },
  qt_record_public:     { ko: "공개 그룹",     de: "Öffentliche Gruppe", en: "Öffentliche Gruppe" },
  qt_record_private:    { ko: "비공개 그룹",    de: "Private Gruppe", en: "Private Gruppe" },
  qt_record_opening:    { ko: "들어가는 기도",  de: "Eröffnungsgebet", en: "Opening Prayer" },
  qt_record_summary:    { ko: "본문 요약",     de: "Zusammenfassung", en: "Zusammenfassung" },
  qt_record_keyverse:   { ko: "붙잡은 말씀",   de: "Schlüsselvers", en: "Schlüsselvers" },
  qt_record_meditation: { ko: "느낌과 묵상",   de: "Empfinden & Meditation", en: "Reflection & Meditation" },
  qt_record_application:{ ko: "성품 (적용)",   de: "Charakter (Anwendung)", en: "Charakter (Anwendung)" },
  qt_record_decision:   { ko: "행동 (결단)",   de: "Handlung (Entschluss)", en: "Handlung (Entschluss)" },
  qt_record_closing:    { ko: "올려드리는 기도", de: "Abschlussgebet", en: "Closing Prayer" },

  // ── Join ──
  join_private:         { ko: "비공개 그룹",      de: "Private Gruppe", en: "Private Gruppe" },
  ...
  // ── 성경 번역본 그룹 라벨 ──
  qt_translation_ko: { ko: "한국어",   de: "Koreanisch", en: "Koreanisch" },
  qt_translation_en: { ko: "English",  de: "Englisch"   },
  qt_translation_de: { ko: "Deutsch",  de: "Deutsch", en: "Deutsch"    },
  qt_translation_fr: { ko: "Français", de: "Französisch", en: "Französisch"},

  // ── QT Write 페이지 ──
  // 6단계 제목 / 부제목 / placeholder / hint
  qtw_s1_title:    { ko: "들어가는 기도",               de: "Eröffnungsgebet", en: "Opening Prayer" },
  qtw_s1_sub:      { ko: "말씀 앞에 나아가기 전 기도",    de: "Gebet vor dem Wort", en: "Gebet vor dem Wort" },
  qtw_s1_ph:       { ko: "주님, 오늘 말씀 앞에 나아갑니다...\n제 눈과 귀와 마음을 열어주세요.", de: "Herr, ich komme heute vor dein Wort...\nÖffne meine Augen, Ohren und mein Herz.", en: "Herr, ich komme heute vor dein Wort...\nÖffne meine Augen, Ohren und mein Herz." },
  qtw_s1_hint:     { ko: "짧아도 괜찮아요. 마음을 열고 주님께 나아가는 기도예요.", de: "Kurz reicht auch. Ein Gebet mit offenem Herzen.", en: "Kurz reicht auch. Ein Gebet mit offenem Herzen." },
  qtw_s2_title:    { ko: "본문 요약 & 붙잡은 말씀",      de: "Zusammenfassung & Schlüsselvers", en: "Summary & Key Verse" },
  qtw_s2_sub:      { ko: "본문을 읽고 마음에 새겨요",     de: "Den Text lesen und ins Herz aufnehmen", en: "Den Text lesen und ins Herz aufnehmen" },
  qtw_s3_title:    { ko: "느낌과 묵상",                 de: "Empfinden & Meditation", en: "Reflection & Meditation" },
  qtw_s3_sub:      { ko: "이 말씀이 내게 주는 의미",     de: "Was bedeutet das Wort für mich?", en: "Was bedeutet das Wort für mich?" },
  ...
  qtw_s3_hint:     { ko: "정답이 없어요. 성령님의 이끄심에 맡겨봐요.", de: "Es gibt keine richtige Antwort. Lassen Sie sich vom Heiligen Geist leiten.", en: "Es gibt keine richtige Antwort. Lassen Sie sich vom Heiligen Geist leiten." },
  qtw_s4_title:    { ko: "적용과 결단",                 de: "Anwendung & Entschluss", en: "Application & Resolution" },
  qtw_s4_sub:      { ko: "오늘 하루 어떻게 살 건가요?",   de: "Wie leben Sie heute?", en: "Wie leben Sie heute?" },
  qtw_s4_hint:     { ko: "성품은 마음을 정하는 것, 행동은 손과 발로 드러나는 것이에요.", de: "Charakter ist die Entscheidung des Herzens, Handlung wird mit Händen und Füßen sichtbar.", en: "Charakter ist die Entscheidung des Herzens, Handlung wird mit Händen und Füßen sichtbar." },
  qtw_s5_title:    { ko: "올려드리는 기도",              de: "Abschlussgebet", en: "Closing Prayer" },
  qtw_s5_sub:      { ko: "말씀으로 드리는 기도",         de: "Gebet mit dem Wort", en: "Gebet mit dem Wort" },
  qtw_s5_ph:       { ko: "말씀을 붙들고 기도를 올려드려요...", de: "Gebet, das das Wort festhält...", en: "Gebet, das das Wort festhält..." },
  qtw_s5_hint:     { ko: "말씀과 결단을 간결하게 다시 하나님께 올려드려요.", de: "Wort und Entschluss noch einmal kurz vor Gott bringen.", en: "Wort und Entschluss noch einmal kurz vor Gott bringen." },

  // 진행바 6칸 라벨
  qtw_bar1: { ko: "들어가는 기도", de: "Eröffnung", en: "Eröffnung" },
  qtw_bar2: { ko: "본문 요약",    de: "Zusammenf.", en: "Zusammenf." },
  qtw_bar3: { ko: "붙잡은 말씀",  de: "Schlüsselvers", en: "Schlüsselvers" },
  qtw_bar4: { ko: "느낌과 묵상", de: "Meditation", en: "Meditation" },
  qtw_bar5: { ko: "적용과 결단", de: "Entschluss", en: "Entschluss" },
  qtw_bar6: { ko: "올려드리는 기도", de: "Abschluss", en: "Abschluss" },

  // 주일예배 단계
  qtw_sun_s0_title: { ko: "설교 정보",           de: "Predigt-Info", en: "Predigt-Info" },
  qtw_sun_s0_sub:   { ko: "설교 제목과 본문 말씀을 적어요", de: "Titel und Bibelstelle der Predigt", en: "Titel und Bibelstelle der Predigt" },
  qtw_sun_s1_title: { ko: "들어가는 기도",        de: "Eröffnungsgebet", en: "Opening Prayer" },
  qtw_sun_s1_sub:   { ko: "예배 전 마음을 준비해요", de: "Herz vorbereiten vor dem Gottesdienst", en: "Herz vorbereiten vor dem Gottesdienst" },
  qtw_sun_s1_ph:    { ko: "주님, 오늘 예배에 나아갑니다...\n제 눈과 귀와 마음을 열어주세요.", de: "Herr, ich komme heute zum Gottesdienst...\nÖffne meine Augen, Ohren und mein Herz.", en: "Herr, ich komme heute zum Gottesdienst...\nÖffne meine Augen, Ohren und mein Herz." },
  qtw_sun_s1_hint:  { ko: "예배 전 마음을 열고 주님께 나아가는 기도예요.", de: "Gebet mit offenem Herzen vor dem Gottesdienst.", en: "Gebet mit offenem Herzen vor dem Gottesdienst." },
  qtw_sun_s2_title: { ko: "말씀 요약",           de: "Zusammenfassung", en: "Zusammenfassung" },
  qtw_sun_s2_sub:   { ko: "설교 말씀을 내 말로 요약해요", de: "Predigt in eigenen Worten zusammenfassen", en: "Predigt in eigenen Worten zusammenfassen" },
  qtw_sun_s2_ph:    { ko: "오늘 설교 핵심 내용을 자신의 말로 요약해보세요...", de: "Fassen Sie die Kernbotschaft der Predigt in eigenen Worten zusammen...", en: "Fassen Sie die Kernbotschaft der Predigt in eigenen Worten zusammen..." },
  qtw_sun_s2_hint:  { ko: "설교자가 전한 핵심 메시지를 나의 말로 정리해요.", de: "Die Kernbotschaft des Predigers in eigene Worte fassen.", en: "Die Kernbotschaft des Predigers in eigene Worte fassen." },
  qtw_sun_s3_title: { ko: "깨달음과 결단",       de: "Erkenntnis & Entschluss", en: "Erkenntnis & Entschluss" },
  qtw_sun_s3_sub:   { ko: "말씀이 내게 주는 깨달음과 결단", de: "Erkenntnis und Entschluss aus dem Wort", en: "Erkenntnis und Entschluss aus dem Wort" },
  qtw_sun_s3_hint:  { ko: "말씀을 통해 깨달은 것, 그리고 삶으로 살아낼 결단을 적어요.", de: "Was Sie erkannt haben und wie Sie es leben wollen.", en: "Was Sie erkannt haben und wie Sie es leben wollen." },
  qtw_sun_s4_title: { ko: "올려드리는 기도",     de: "Abschlussgebet", en: "Closing Prayer" },
  qtw_sun_s4_sub:   { ko: "예배의 마무리 기도",   de: "Abschlussgebet des Gottesdienstes", en: "Abschlussgebet des Gottesdienstes" },
  qtw_sun_s4_ph:    { ko: "오늘 받은 은혜와 결단을 하나님께 올려드려요...", de: "Die empfangene Gnade und den Entschluss vor Gott bringen...", en: "Die empfangene Gnade und den Entschluss vor Gott bringen..." },
  qtw_sun_s4_hint:  { ko: "받은 말씀과 결단을 하나님께 올려드려요.", de: "Das Wort und den Entschluss Gott darbringen.", en: "Das Wort und den Entschluss Gott darbringen." },

  // 말씀 선택
  qtw_find_passage:        { ko: "오늘의 말씀 찾기",              de: "Heutigen Abschnitt suchen", en: "Heutigen Abschnitt suchen" },
  qtw_find_passage_opt:    { ko: "오늘의 말씀 찾기 (선택)",        de: "Heutigen Abschnitt suchen (optional)", en: "Heutigen Abschnitt suchen (optional)" },
  qtw_today:               { ko: "오늘",                         de: "Heute", en: "Today" },
  qtw_cross_chapter:       { ko: "장이 넘어가는 말씀 (예: 9장 25절~10장 6절)", de: "Kapitel-übergreifend (z. B. 9,25 – 10,6)", en: "Kapitel-übergreifend (z. B. 9,25 – 10,6)" },
  qtw_err_verse_range:     { ko: "끝 절이 시작 절보다 작아요",       de: "Endvers ist kleiner als Startvers", en: "Endvers ist kleiner als Startvers" },
  qtw_err_load_passage:    { ko: "본문을 불러오지 못했어요.",       de: "Abschnitt konnte nicht geladen werden.", en: "Abschnitt konnte nicht geladen werden." },

  // 저장 / 임시저장
  qtw_draft_saved:         { ko: "임시저장됐어요! 나중에 이어쓸 수 있어요 😊", de: "Als Entwurf gespeichert! Sie können später weitermachen 😊", en: "Als Entwurf gespeichert! Sie können später weitermachen 😊" },
  qtw_draft_failed:        { ko: "임시저장에 실패했어요. 다시 시도해주세요.", de: "Entwurf konnte nicht gespeichert werden. Bitte erneut versuchen.", en: "Entwurf konnte nicht gespeichert werden. Bitte erneut versuchen." },
  qtw_save_failed:         { ko: "저장에 실패했어요. 다시 시도해주세요.", de: "Speichern fehlgeschlagen. Bitte erneut versuchen.", en: "Speichern fehlgeschlagen. Bitte erneut versuchen." },

  // 자유형식 placeholder
  qtw_free_ph:             { ko: "오늘 읽은 말씀, 느낀 점, 깨달음을 자유롭게 적어보세요...", de: "Schreiben Sie frei über das Wort, Ihre Gedanken und Erkenntnisse...", en: "Schreiben Sie frei über das Wort, Ihre Gedanken und Erkenntnisse..." },

  // 주일예배 입력 placeholder
  qtw_sermon_title_ph:     { ko: "예: 두려워하지 말라",           de: "z. B. Fürchte dich nicht", en: "z. B. Fürchte dich nicht" },
  qtw_sermon_ref_ph:       { ko: "예: 이사야 41:10 / 요한복음 3:16", de: "z. B. Jesaja 41,10 / Johannes 3,16", en: "z. B. Jesaja 41,10 / Johannes 3,16" },
  qtw_meditation_ph_sun:   { ko: "개인적이고 솔직하게 써보세요...", de: "Persönlich und ehrlich schreiben...", en: "Persönlich und ehrlich schreiben..." },
  qtw_app_ph_short:        { ko: "이 말씀 앞에서 어떤 마음을 품기로 결심했나요?", de: "Welche Haltung nehmen Sie vor diesem Wort ein?", en: "Welche Haltung nehmen Sie vor diesem Wort ein?" },

  // 주일 단계 라벨들 & 필드
  qtw_sermon_title_label:  { ko: "설교 제목",         de: "Predigttitel", en: "Predigttitel" },
  qtw_sermon_ref_label:    { ko: "본문 말씀",         de: "Bibelstelle", en: "Bibelstelle" },

  // 6단계 본문 요약 입력
  qtw_summary_ph:          { ko: "본문 내용을 자신의 말로 요약해보세요...", de: "Fassen Sie den Text in eigenen Worten zusammen...", en: "Fassen Sie den Text in eigenen Worten zusammen..." },
  qtw_keyverse_ph:         { ko: "마음에 와닿은 구절을 적거나 위에서 선택하세요...", de: "Schreiben Sie den berührenden Vers oder wählen Sie oben...", en: "Schreiben Sie den berührenden Vers oder wählen Sie oben..." },
  qtw_application_ph:      { ko: "이 말씀 앞에서 어떤 마음을 품기로 결심했나요?", de: "Welche Haltung nehmen Sie vor diesem Wort ein?", en: "Welche Haltung nehmen Sie vor diesem Wort ein?" },

  // 단계 라벨
  qtw_step_label:          { ko: "단계",              de: "Schritt", en: "Schritt" },
  qtw_character_label:     { ko: "성품",              de: "Charakter", en: "Charakter" },
  qtw_action_label:        { ko: "행동",              de: "Handlung", en: "Handlung" },

  // 저장 버튼
  qtw_save_btn:            { ko: "저장하기",          de: "Speichern", en: "Save" },
  qtw_saving:              { ko: "저장 중...",        de: "Wird gespeichert...", en: "Wird gespeichert..." },
  qtw_save_draft:          { ko: "임시저장",          de: "Als Entwurf", en: "Als Entwurf" },
  qtw_next_step:           { ko: "다음 단계 →",       de: "Nächster Schritt →", en: "Nächster Schritt →" },
  qtw_prev_step:           { ko: "← 이전",            de: "← Zurück", en: "← Zurück" },

  // 주일예배 UI에 있는 기타 요소들 (section label / badge label 등)
  qtw_character_section:   { ko: "성품 (Be) — 마음의 결심", de: "Charakter — Haltung des Herzens", en: "Charakter — Haltung des Herzens" },
  qtw_action_section:      { ko: "행동 (Do) — 손과 발",    de: "Handlung — Hände und Füße", en: "Handlung — Hände und Füße" },
  qtw_char_ph:             { ko: "어떤 마음가짐을 가질까요?", de: "Welche Haltung nehmen Sie ein?", en: "Welche Haltung nehmen Sie ein?" },
  qtw_add_action:          { ko: "+ 행동 추가",        de: "+ Handlung hinzufügen", en: "+ Handlung hinzufügen" },
  qtw_action_ph:           { ko: "예: 하루 한 번 말씀 묵상", de: "z. B. Einmal am Tag meditieren", en: "z. B. Einmal am Tag meditieren" },
  ...
  qtw_passage_loaded:      { ko: "본문이 준비됐어요",    de: "Abschnitt bereit", en: "Abschnitt bereit" },

  // 번역본 라벨
  qtw_translation_label:   { ko: "번역본",            de: "Übersetzung", en: "Übersetzung" },
  qtw_change_translation:  { ko: "번역본 변경",        de: "Übersetzung ändern", en: "Übersetzung ändern" },
