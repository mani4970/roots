...
export const T = {
  ...
  home_streak: { ko: "일 연속 기록 중 🔥",            de: "Tage in Folge 🔥", en: "days in a row 🔥", fr: "jours de suite 🔥" },
  home_routine_complete: { ko: "오늘 루틴 완료! 정원을 확인해보세요 🌱", de: "Heute erledigt! Garten ansehen 🌱", en: "Today's routine done! Check your garden 🌱", fr: "Routine du jour terminée ! Regardez votre jardin 🌱" },

  // ── 감정 체크인 ──
  checkin_title: { ko: "오늘 마음이\n어때요?",   de: "Wie fühlen\nSie sich?", en: "How are you\nfeeling?", fr: "Comment est votre\\ncœur aujourd’hui ?" },
  checkin_sub: { ko: "하나를 선택하면 말씀을 드릴게요", de: "Wählen Sie eines aus", en: "Pick one and receive a verse", fr: "Choisissez un état et recevez un verset" },
  ...
  qt_done_sub: { ko: "말씀 앞에 앉은 당신, 축복해요", de: "Gut gemacht!", en: "!", fr: "Soyez béni(e) !" },
  ...
  // ── 커뮤니티 ──
  community_create_group: { ko: "그룹 만들기",        de: "Gruppe erstellen", en: "Create group", fr: "Créer un groupe" },
  ...
  profile_streak: { ko: "일 연속 기록 중 🔥",       de: "Tage in Folge 🔥", en: "days in a row 🔥", fr: "jours de suite 🔥" },
  ...
  profile_feedback_ok: { ko: "소중한 의견 감사해요! 😊", de: "Vielen Dank für Ihr Feedback! 😊", en: "Thank you for your feedback! 😊", fr: "Merci pour votre retour ! 😊" },
  ...
  home_prayer_quiet_celeb: { ko: "오늘의 기도를 하나님께 드렸어요 🙏", de: "Sie haben Ihr heutiges Gebet Gott gebracht 🙏", en: "You offered today's prayer to God 🙏", fr: "Vous avez offert la prière du jour à Dieu 🙏" },
  home_prayer_quiet_celeb_sub: { ko: "조용한 기도도 귀한 루틴이에요.", de: "Auch ein stilles Gebet ist ein kostbarer Teil Ihrer Routine.", en: "Even a quiet prayer is a precious part of your routine.", fr: "Même une prière silencieuse est une précieuse partie de votre routine." },
  ...
  qt_today_done_sub: { ko: "말씀 앞에 앉은 당신, 축복해요.",       de: "Gesegnet – Sie waren beim Wort Gottes.", en: "Bless you — you were with God's Word.", fr: "Sois béni — vous étiez avec la Parole de Dieu." },
