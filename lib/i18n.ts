...
export const T = {
  ...
  community_badge_peter_title: { ko: "동행 배지 획득! 🤝", de: "Abzeichen Gemeinsam unterwegs! 🤝", en: "Walking Together Badge! 🤝", fr: "Badge En route ensemble ! 🤝" },
  ...
  prayer_badge_warrior_popup: { ko: "기도의 불씨 배지 획득! 🔥", de: "Abzeichen Gebetsglut! 🔥", en: "Prayer Ember Badge! 🔥", fr: "Badge Braise de prière ! 🔥" },
  ...
  badge_prayer_warrior_title: { ko: "기도의 불씨",    de: "Gebetsglut", en: "Prayer Ember", fr: "Braise de prière" },
  badge_prayer_warrior_desc: { ko: "중보기도 요청 7회", de: "7 Fürbitten erbeten", en: "7 intercession requests", fr: "7 demandes d’intercession" },
  ...
  badge_peter_title: { ko: "동행",              de: "Gemeinsam unterwegs", en: "Walking Together", fr: "En route ensemble" },
  badge_peter_desc: { ko: "커뮤니티 그룹 5개 참여",       de: "An 5 Community-Gruppen teilnehmen", en: "Joined 5 community groups", fr: "Participation à 5 groupes de communauté" },
  badge_qt_bird_title: { ko: "말씀의 평안",          de: "Ruhe im Wort", en: "Peace in the Word", fr: "Paix dans la Parole" },
  badge_qt_bird_desc: { ko: "큐티 나눔 50회",       de: "50 geteilte QTs", en: "50 QTs shared", fr: "50 QT partagés" },
  ...
  badge_peter_msg: { ko: "공동체와 함께 순방향의 길로 나아가는 당신을 축복합니다!", de: "Gesegnet seien Sie, der gemeinsam mit der Gemeinschaft auf dem guten Weg vorangeht!", en: "Blessings on you as you walk forward together with the community!", fr: "Soyez béni(e) alors que vous avancez avec la communauté sur un chemin de vie !" },
  ...
  qt_record_badge_qt_bird_title: { ko: "말씀의 평안 배지 획득! 🌿", de: "Abzeichen Ruhe im Wort! 🌿", en: "Peace in the Word Badge! 🌿", fr: "Badge Paix dans la Parole ! 🌿" },
