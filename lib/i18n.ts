...
export const T = {
  ...
  onboarding_desc3_sub: { ko: "하나님이 이루시는 일들의 증인이 되세요!", de: "Werden Sie Zeuge dessen, was Gott tut!", en: "Become a witness to what God is doing!", fr: "Devenez témoin de ce que Dieu accomplit !" },
  ...
  onboarding_desc5: { ko: "QT를 완료하면\n겨자씨 한 알이 자라 100일 후에 공중의 새들이 깃들이는 정원이 돼요.", de: "Wenn Sie eine QT abschließen,\nwächst ein Senfkorn und wird nach 100 Tagen zu einem Garten, in dem die Vögel nisten.", en: "When you complete Quiet Time,\na mustard seed grows into a garden where birds can nest after 100 days.", fr: "Quand vous terminez un QT,\nun grain de moutarde grandit et devient après 100 jours un jardin où les oiseaux peuvent se poser." },
  onboarding_desc5_sub: { ko: "언제든 다시 하나님과 동행해요.", de: "Gehen Sie jederzeit wieder mit Gott.", en: "You can walk with God again anytime.", fr: "Vous pouvez reprendre la marche avec Dieu à tout moment." },
