...
const FR_OVERRIDES = {
  ...
  nav_profile: "Profil",
  home_title: "Routine du jour",
  home_checkin_btn: "Recevoir le verset du jour",
  home_checkin_done: "Verset du jour",
  home_qt_btn: "QT du jour",
  home_qt_done: "QT terminée",
  home_prayer_title: "Prière du jour",
  home_prayer_yes: "J’ai prié",
  home_prayer_later: "Plus tard",
  home_prayer_done: "Prière terminée",
  home_decision_title: "Ma résolution",
  home_decision_done: "Résolution accomplie",
  home_decision_check: "J’ai mis cette résolution en pratique",
  home_streak: "{n} jours de suite",
  home_routine_complete: "Routine terminée",
  home_loading_sub: "Enraciné dans la Parole, grandir ensemble",
  home_next_step_section: "Le pas d’aujourd’hui",
  home_next_step_checkin_title: "Commencez par le verset du jour",
  home_next_step_checkin_sub: "Choisissez votre état du cœur et recevez une Parole adaptée.",
  home_next_step_qt_title: "Faites votre QT aujourd’hui",
  home_next_step_qt_sub: "Aujourd’hui, nous recommandons la QT en 6 étapes.",
  home_next_step_qt_primary: "Commencer la QT en 6 étapes",
  home_next_step_qt_secondary: "Faire une QT libre",
  home_next_step_sunday_title: "Aujourd’hui, c’est dimanche",
  home_next_step_sunday_sub: "Faites votre QT avec le culte du dimanche.",
  home_next_step_sunday_btn: "Commencer la QT du culte",
  home_next_step_draft_title: "Continuer votre QT",
  home_next_step_draft_sub: "Un brouillon d’aujourd’hui est disponible.",
  home_next_step_prayer_title: "Prier aujourd’hui",
  home_next_step_prayer_sub: "Vous pouvez prier en silence ou noter un sujet de prière.",
  home_next_step_decision_title: "Avez-vous choisi votre résolution du jour ?",
  home_next_step_decision_sub: "Même une petite résolution peut devenir un acte de foi.",
  home_next_step_decision_placeholder: "Écrivez une petite résolution pour aujourd’hui",
  home_next_step_decision_save: "Enregistrer la résolution",
  home_next_step_complete_title: "Aujourd’hui encore, les racines de votre foi grandissent.",
  home_next_step_complete_sub: "RootsMan arrose votre jardin. Continuez à grandir.",
  home_next_step_complete_btn: "Voir le jardin",
  home_prayer_section: "Prière du jour",
  home_prayer_desc: "Présentez votre prière à Dieu aujourd’hui.",
  home_prayer_done_msg: "Prière terminée ! 🙏",
  home_prayer_quiet_option: "J’ai prié en silence",
  home_prayer_write_option: "Noter un sujet de prière",
  home_prayer_save_error: "La prière du jour n’a pas pu être enregistrée.",
  home_decision_save_error: "La résolution n’a pas pu être enregistrée.",
  home_routine_section: "Routine du jour",
  home_routine_qt: "QT",
  home_routine_prayer: "Prière",
  home_routine_decision: "Résolution",
  home_routine_done: "Terminé ✓",
  home_routine_notdone: "Ouvert",
  home_routine_open: "Ouvrir →",
  home_celebration_title: "Aujourd’hui encore, les racines de votre foi grandissent.",
  home_celebration_sub: "RootsMan arrose votre jardin. Regardez la croissance du jour.",
  home_celebration_sub_prefix: "",
  home_garden_my: "Le jardin de {name}",
  home_recommend_section: "Résolution recommandée",
  home_decision_practice: "J’ai mis cette résolution en pratique aujourd’hui",
  home_qt_choice_title: "Comment voulez-vous faire votre QT aujourd’hui ?",
  home_qt_choice_sub: "Nous recommandons la QT en 6 étapes. Si cela semble trop lourd, commencez simplement en forme libre.",
  home_qt_choice_6step: "Commencer la QT en 6 étapes",
  home_qt_choice_free: "Faire une QT libre",
  home_qt_choice_guide: "Voir le guide en 6 étapes",
  home_qt_choice_close: "Fermer",
  home_qt_sunday_title: "Aujourd’hui, c’est dimanche 🙌",
  home_qt_sunday_sub: "Faites votre QT avec la Parole du culte.",
  home_qt_sunday_start: "Commencer la QT du culte du dimanche",
  checkin_title: "Comment est votre cœur aujourd’hui ?",
  checkin_sub: "Choisissez l’état qui vous correspond.",
  checkin_cat1: "Joie & gratitude",
  checkin_cat2: "Grâce & soif spirituelle",
  checkin_cat3: "Fatigue & difficulté",
  checkin_cat4: "Doute & sécheresse",
  checkin_cat5: "Prière du jour",
  checkin_receive: "Recevoir le verset →",
  emotion_grateful: "Reconnaissant",
  emotion_joyful: "Joyeux",
  emotion_peaceful: "Paisible",
  emotion_excited: "Excité",
  emotion_full: "Comblé",
  emotion_grace: "Dans la grâce",
  emotion_hungry: "Soif de Dieu",
  emotion_mission: "Appelé",
  emotion_repent: "Repentant",
  emotion_renew: "Renouvelé",
  emotion_tired: "Fatigué",
  emotion_exhausted: "Épuisé",
  emotion_lonely: "Seul",
  emotion_sad: "Triste",
  emotion_anxious: "Inquiet",
  emotion_doubt: "Dans le doute",
  emotion_dry: "Sec spirituellement",
  emotion_angry: "En colère",
  emotion_far: "Loin de Dieu",
  emotion_family: "Famille",
  emotion_work: "Travail",
  emotion_relation: "Relations",
  emotion_health: "Santé",
  emotion_future: "Avenir",
  result_loading: "Recherche d’un verset pour vous...",
  result_title: "Votre verset du jour",
  result_sub: "Une Parole pour votre cœur aujourd’hui.",
  result_mission: "Résolution recommandée",
  result_home_btn: "Retour à l’accueil",
  result_home_sub: "Enracinez cette Parole dans votre journée.",
  back: "Retour",
  qt_title: "QT",
  qt_sub: "Un temps calme avec la Parole",
  qt_start_btn: "Commencer la QT du jour",
  qt_sunday_required: "Aujourd’hui c’est dimanche ! Veuillez faire une QT du culte du dimanche. 🙌",
  qt_done: "QT terminée aujourd’hui !",
  qt_done_sub: "Bravo d’être resté devant la Parole.",
  qt_sunday: "🙌 Aujourd’hui, c’est dimanche !",
  qt_sunday_sub: "Utilisez le message du culte pour votre QT.",
  qt_today_passage: "Passage QT du jour",
  qt_records: "Archives QT",
  qt_no_records: "Aucune QT enregistrée pour le moment",
  qt_no_records_simple: "Aucun enregistrement QT pour le moment",
  qt_mode_6step: "QT en 6 étapes",
  qt_mode_sunday: "QT du culte du dimanche",
  qt_mode_free: "QT libre",
  qt_mode_sunday_title: "QT du culte du dimanche",
  qt_mode_select: "Choisir le type de QT",
  qt_draft_title: "Brouillon trouvé",
  qt_draft_sub: "Voulez-vous continuer la QT d’aujourd’hui ?",
  qt_draft_continue: "Continuer",
  qt_draft_new: "Recommencer",
  qt_draft_later: "Plus tard",
  qt_write_opening: "Prière d’ouverture",
  qt_write_summary: "Résumé & verset clé",
  qt_write_meditate: "Ressenti & méditation",
  qt_write_decision: "Application & résolution",
  qt_write_closing: "Prière finale",
  qt_write_save: "Enregistrer",
  qt_write_draft: "Brouillon",
  qt_write_complete: "Terminer la QT",
  qt_step_summary: "Étape 2 · Résumé du passage",
  qt_step_keyverse: "Étape 3 · Verset clé",
  qt_step_meditate: "Étape 4 · Ressenti & méditation",
  qt_step_decision: "Étape 5 · Application & résolution",
  prayer_title: "Prière",
  prayer_tab_praying: "En prière 🙏",
  prayer_tab_answered: "Exaucées",
  prayer_add: "Ajouter une prière",
  prayer_placeholder: "Entrez un sujet de prière...",
  prayer_save: "Enregistrer",
  prayer_together: "Prier ensemble",
  prayer_prayed: "J’ai prié",
  prayer_answered: "Exaucée",
  community_create_group: "Créer un groupe",
  community_join_group: "Rejoindre un groupe",
  community_tab_prayer: "Prière",
  community_tab_qt: "QT",
  community_tab_group: "Groupe",
  profile_faith_journey: "Parcours de foi",
  profile_faith_fruits: "Badges de foi",
  profile_spirit_fruits: "Fruits de l’Esprit",
  profile_qt_calendar: "Calendrier QT",
  profile_invite: "Inviter des amis",
  profile_invite_title: "Invitation à Roots",
  profile_invite_text: "🌱 Roots - enraciné dans la Parole, grandir ensemble\n\nUne application chrétienne pour grandir fidèlement avec la QT, la prière et les résolutions quotidiennes.\nCommençons ensemble ! 👇\nhttps://christian-roots.com",
  profile_invite_copied: "Texte d’invitation copié.",
  profile_feedback: "💬 Envoyer un avis",
  profile_feedback_placeholder: "Écrivez votre avis...",
  profile_feedback_send: "Envoyer",
  profile_feedback_sending: "Envoi...",
  profile_feedback_title: "💬 Envoyer un avis",
  profile_feedback_sub: "Remarques, idées ou encouragements — tout est bienvenu !",
  profile_feedback_ok: "Merci pour votre retour ! 😊",
  profile_feedback_fail: "Échec de l’envoi. Veuillez réessayer.",
  profile_account: "Gestion du compte",
  profile_delete: "Supprimer le compte",
  profile_deleting: "Suppression...",
  profile_delete_error: "Erreur lors de la suppression. Veuillez contacter cookiko313@gmail.com.",
  profile_qt_share: "Partages QT",
  profile_default_name: "Utilisateur",
  profile_badge_earned: "✓ Obtenu",
  login_title: "Se connecter",
  login_btn: "Connexion",
  signup_title: "Créer un compte",
  signup_nickname: "Pseudo",
  signup_nickname_ph: "Entrez un pseudo",
  ...
  weekday_fri: "Ven",
  weekday_sat: "Sam",
  onboarding_title1: "Bienvenue sur Roots",
  onboarding_desc1: "S’enraciner dans la Parole et grandir ensemble.\nAvec trois routines quotidiennes, créez un temps plus profond avec Dieu.",
  onboarding_desc1_sub: "",
  onboarding_title2: "Recevez un verset pour aujourd’hui",
  onboarding_desc2: "Choisissez votre émotion ou votre état du moment,\net Roots vous recommandera un verset adapté à votre cœur.",
  onboarding_desc2_sub: "Nous recommandons un verset adapté à votre cœur et à votre état actuel.",
  onboarding_title3: "Planter la Parole en 6 étapes",
  onboarding_desc3: "① Prière d’ouverture\n② Résumé du passage\n③ Verset clé\n④ Réflexion & méditation\n⑤ Application & résolution\n⑥ Prière finale",
  onboarding_desc3_sub: "Même si vous débutez, c’est possible.\nChaque étape est guidée.",
  onboarding_title4: "Notez vos prières et voyez les réponses",
  onboarding_desc4: "Écrivez vos sujets de prière et laissez un témoignage lorsqu’ils sont exaucés.\nVous pouvez aussi demander l’intercession.",
  onboarding_desc4_sub: "De la prière à l’exaucement,\ngardez une trace de l’œuvre de Dieu.",
  onboarding_title5: "Votre jardin grandit chaque jour",
  onboarding_desc5: "Quand vous complétez QT + prière + résolution,\nvotre arbre grandit et vous recevez un fruit de l’Esprit tous les 100 jours.",
  onboarding_desc5_sub: "La constance est essentielle.\nCommencez aujourd’hui ! 🌱",
  onboarding_next: "Suivant →",
  onboarding_start: "Commencer 🌱",
  onboarding_skip: "Passer",
  welcome_back_1_sub: "Une journée manquée n’efface pas vos racines.",
  welcome_back_30_title: "Cela fait longtemps !",
  welcome_back_30_sub: "Dieu vous attend encore aujourd’hui.",
  spirit_fruit_title: "Fruit de l’Esprit obtenu ! 🎉",
  garden_badge_100days: "100 jours enraciné dans la Parole —\nvoici un fruit que Dieu vous donne !",
  garden_badge_profile: "À voir dans le profil ✨",
  rootsman_title: "RootsMan arrose le jardin",
  rootsman_check: "Regardez le jardin 🌱",
  rootsman_btn: "Voir le jardin",
  rootsman_msg_1: "La graine commence à prendre racine.",
  rootsman_msg_2: "Une petite pousse apparaît.",
  rootsman_msg_3: "Le jeune plant grandit vers la lumière.",
  rootsman_msg_4: "Les branches s’étendent et les racines s’approfondissent.",
  rootsman_msg_5: "L’arbre grandit avec force.",
  rootsman_msg_6: "Vous vous enracinez de plus en plus dans la Parole.",
  rootsman_msg_7: "Les fruits commencent à apparaître. Continuez !",
  rootsman_msg_8: "L’arbre a grandi assez pour accueillir les oiseaux.",
  rootsman_msg_9: "Un beau jardin prend forme.",
  rootsman_msg_10: "Un jardin abondant porte du fruit.",
  tree_progress: "{n} / 10",
  tree_day_count: "Jour {n}",
  tree_garden_n: "Jardin n° {n}",
  tree_stage_0: "Graine 🌱",
  tree_stage_1: "Pousse 🌿",
  tree_stage_2: "Jeune plant",
  tree_stage_3: "Branches",
  tree_stage_4: "Arbre solide",
  tree_stage_5: "Feuilles abondantes",
  tree_stage_6: "Fruit qui grandit",
  tree_stage_7: "Oiseaux au jardin",
  tree_stage_8: "Jardin lumineux",
  tree_stage_9: "Presque complet",
  tree_stage_10: "Jardin abondant 🌳",
  qt_g1_title: "Prière d’ouverture",
  qt_g1_desc: "Le premier pas pour se présenter devant Dieu.",
  qt_g1_ex: "Seigneur, ouvre mes yeux pour voir ta Parole, mes oreilles pour entendre et mon cœur pour recevoir.",
  qt_g2_title: "Résumé du texte",
  qt_g2_desc: "Relisez le passage et résumez-le avec vos propres mots.",
  qt_g3_title: "Verset clé",
  qt_g3_desc: "Choisissez le verset qui touche votre cœur aujourd’hui.",
  qt_g4_title: "Réflexion & méditation",
  qt_g4_desc: "Notez ce que vous ressentez et ce que Dieu vous montre.",
  qt_g5_title: "Application & résolution",
  qt_g5_desc: "Transformez la Parole en une petite action concrète.",
  qt_g6_title: "Prière finale",
  qt_g6_desc: "Confiez votre journée et votre résolution à Dieu.",
  lang_picker_title: "Choisissez la langue",
  lang_picker_sub: "Veuillez sélectionner votre langue",
  lang_continue: "Continuer",
  qt_translation_ko: "Coréen",
  qt_translation_en: "Anglais",
  qt_translation_de: "Allemand",
  qt_translation_fr: "Français",
  qtw_s1_title: "Prière d’ouverture",
  qtw_s1_sub: "Prière avant la Parole",
  qtw_s1_ph: "Seigneur, je viens devant ta Parole aujourd’hui...\nOuvre mes yeux, mes oreilles et mon cœur.",
  qtw_s1_hint: "Commencez par une courte prière.",
  qtw_s2_title: "Résumé du passage",
  qtw_s2_sub: "Exprimez le contenu avec vos propres mots.",
  qtw_s3_title: "Verset clé",
  qtw_s3_sub: "Quel verset voulez-vous tenir aujourd’hui ?",
  qtw_s3_ph: "Écrivez le verset qui touche votre cœur...",
  qtw_s3_hint: "Touchez un verset pour l’ajouter.",
  qtw_s4_title: "Ressenti & méditation",
  qtw_s4_sub: "Qu’est-ce que la Parole vous fait ressentir ?",
  qtw_s4_hint: "Soyez honnête devant Dieu.",
  qtw_s5_title: "Application & résolution",
  qtw_s5_sub: "Comment allez-vous vivre cette Parole ?",
  qtw_s5_ph: "Écrivez une résolution concrète...",
  qtw_s5_hint: "Une petite action suffit.",
  qtw_bar1: "Ouverture",
  qtw_bar2: "Résumé",
  qtw_bar3: "Verset clé",
  qtw_bar4: "Méditation",
  qtw_bar5: "Résolution",
  qtw_bar6: "Prière finale",
  qtw_save_btn: "Terminer la QT",
  qtw_saving: "Enregistrement...",
  qtw_save_draft: "Enregistrer le brouillon",
  qtw_next_step: "Suivant →",
  qtw_prev_step: "← Retour",
  qtw_translation_label: "Traduction",
  qtw_change_translation: "Changer de traduction",
  qtw_wd_0: "Dim",
  qtw_wd_1: "Lun",
  qtw_wd_2: "Mar",
  qtw_wd_3: "Mer",
  ...
  qtw_wd_5: "Ven",
  qtw_wd_6: "Sam",
  join_private: "Groupe privé",
  join_invite: "Invitation de groupe",
  join_private_invite: "Invitation à un groupe privé",
  join_btn: "Rejoindre le groupe"
} satisfies Partial<Record<TKey, string>>;
...
export function t(key: TKey, lang: Lang = FALLBACK_LANG, vars?: Record<string, string | number>): string {
  ...
  let str = (lang === "fr" ? FR_OVERRIDES[key] : undefined) ?? entry[lang] ?? (lang === "fr" ? entry.en : undefined) ?? entry[FALLBACK_LANG] ?? String(key);
  if (vars) {
