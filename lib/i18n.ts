...
export const T = {
  ...
  result_sub:       { ko: "현재 감정과 상태에 맞는 말씀이에요", de: "Ein Vers passend zu Ihrem heutigen Herzen", en: "A verse for your current heart and state" },
  result_mission:   { ko: "",         de: "", en: "" },
  result_home_btn:  { ko: "홈에서 확인하기 →",        de: "Zur Startseite →", en: "Go to Home →" },
  result_home_sub:  { ko: "홈에서 오늘의 말씀을 확인할 수 있어요", de: "Sie können den heutigen Vers auf der Startseite sehen", en: "You can view today's verse on the home screen" },
  ...
  badge_angel_desc:     { ko: "100일 루틴 완주로 받은 성령의 열매 배지",      de: "Abzeichen für 100 erfüllte Routinetage", en: "Fruit of the Spirit badge for completing a 100-day routine cycle" },

  // 뱃지 팝업 메시지
  badge_rootsman_msg:       { ko: "7일간 말씀과 함께한 당신, Roots의 진짜 시작이에요!", de: "7 Tage mit Gottes Wort – ein echter Anfang bei Roots!", en: "7 days in a row! RootsMan is walking with you!" },
  ...
  // ── 온보딩 ──
  onboarding_title1:  { ko: "Roots에 오신 걸 환영해요",  de: "Willkommen bei Roots", en: "Welcome to Roots" },
  onboarding_desc1:   { ko: "말씀에 뿌리내리고, 함께 자라다.\n매일 3가지 루틴으로 \n하나님과 깊어지는 시간을 만들어요.", de: "In Gottes Wort verwurzelt, gemeinsam wachsen.\n3 tägliche Routinen für eine tiefere Zeit mit Gott.", en: "Root yourself in God’s Word and grow each day.\nBuild a deeper daily rhythm with God through three simple routines." },
  onboarding_desc1_sub: { ko: "", de: "", en: "" },
  onboarding_title2:  { ko: "오늘 마음에 맞는 말씀을 받아요", de: "Ein Vers für Ihr heutiges Herz", en: "Receive a verse for today" },
  onboarding_desc2:   { ko: "오늘의 감정이나 상태를 선택하면\nRoots가 그 마음에 맞는 말씀을 추천해 드려요.", de: "Wenn Sie Ihre heutige Stimmung oder Ihren Zustand wählen,\nempfiehlt Roots Ihnen einen passenden Vers.", en: "Choose your current emotion or state,\nand Roots will recommend a verse that fits your heart today." },
  onboarding_desc2_sub: { ko: "현재 감정과 상태에 맞는 말씀을 추천해 드립니다.", de: "Wir empfehlen Ihnen einen Vers, der zu Ihrem heutigen Herzen und Zustand passt.", en: "We recommend a verse that matches your current heart and state." },
  ...
  home_next_step_section: { ko: "오늘의 한 걸음",       de: "Ihr nächster Schritt", en: "Your next step" },
  home_next_step_checkin_title: { ko: "오늘의 말씀부터 받아보세요", de: "Starten Sie mit dem heutigen Vers", en: "Start with today's verse" },
  home_next_step_checkin_sub:   { ko: "지금 마음 상태로 말씀과 결단을 먼저 받아보면 오늘 QT가 훨씬 쉬워져요.", de: "Wählen Sie zuerst Ihre heutige Stimmung. Dann wird Ihre QT viel leichter beginnen.", en: "Start with today's mood so your verse and resolution can guide today's QT." },
  home_next_step_draft_title:   { ko: "작성 중인 QT가 있어요", de: "Sie haben eine begonnene QT", en: "You have a QT in progress" },
  home_next_step_draft_sub:     { ko: "큐티 탭으로 가지 않아도 홈에서 바로 이어서 쓸 수 있어요.", de: "Sie können direkt von der Startseite aus weiterschreiben.", en: "You can resume it right here without going into the QT tab." },
  home_next_step_qt_title:      { ko: "오늘 QT를 시작해보세요", de: "Beginnen Sie heute Ihre QT", en: "Start today's QT" },
  home_next_step_qt_sub:        { ko: "오늘은 6단계 QT를 기본으로 추천해요. 부담되면 자유형식으로 시작해도 괜찮아요.", de: "Heute empfehlen wir die 6-Schritte-QT. Wenn es zu viel wirkt, können Sie frei beginnen.", en: "Today we recommend the 6-step QT. If that feels heavy, you can start with the free format." },
  home_next_step_sunday_title:  { ko: "오늘은 주일예배 QT로 묵상해보세요", de: "Heute ist Sonntagsgottesdienst-QT dran", en: "Today is for Sunday worship QT" },
  home_next_step_sunday_sub:    { ko: "예배 말씀과 설교를 가지고 오늘 받은 은혜를 정리해보세요.", de: "Nehmen Sie die Predigt und den Bibeltext mit in Ihre heutige Meditation.", en: "Use today's sermon and passage to reflect on what you received in worship." },
  home_next_step_qt_primary:    { ko: "6단계로 시작",          de: "Mit 6 Schritten starten", en: "Start with 6 steps" },
  home_next_step_qt_secondary:  { ko: "자유형식으로 시작",      de: "Frei beginnen", en: "Start free-form" },
  home_next_step_sunday_btn:    { ko: "주일예배 QT 시작",      de: "Sonntags-QT starten", en: "Start Sunday worship QT" },
  home_next_step_prayer_title:  { ko: "오늘의 기도를 드려보세요", de: "Nehmen Sie sich heute Zeit zum Gebet", en: "Offer today's prayer" },
  home_next_step_prayer_sub:    { ko: "글로 남기지 않아도 괜찮아요. 조용히 기도하거나, 필요한 경우 기도 제목을 적어두세요.", de: "Sie müssen nichts aufschreiben. Beten Sie still oder notieren Sie bei Bedarf ein Gebetsanliegen.", en: "You do not have to write anything down. Pray quietly, or save a prayer request if you need to." },
  home_next_step_prayer_btn:    { ko: "기도 기록하러 가기",     de: "Zum Gebet", en: "Go to prayer" },
  home_next_step_decision_empty_title:{ ko: "아직 오늘 결단을 정하지 못하셨나요?", de: "Haben Sie Ihren heutigen Vorsatz noch nicht festgelegt?", en: "Have you not chosen today's resolution yet?" },
  home_next_step_decision_empty_sub:{ ko: "간단한 결단이라도 적어보고, 실행한 뒤 체크해보세요.", de: "Notieren Sie auch einen kleinen Vorsatz und haken Sie ihn nach der Umsetzung ab.", en: "Write down even a simple resolution, then check it off after you live it out." },
  home_next_step_decision_placeholder:{ ko: "예: 오늘 감사 한 가지를 꼭 전하기", de: "z. B. Heute bewusst einen Dank aussprechen", en: "e.g. Share one word of gratitude today" },
  home_next_step_decision_save:{ ko: "결단 저장하기", de: "Vorsatz speichern", en: "Save resolution" },
  home_next_step_decision_title:{ ko: "오늘의 적용을 실천해보세요", de: "Leben Sie die heutige Anwendung", en: "Practice today's application" },
  home_next_step_decision_sub:  { ko: "말씀을 읽었다면 이제 삶으로 이어갈 차례예요. 오늘의 적용을 체크해보세요.", de: "Wenn Sie das Wort gelesen haben, ist jetzt die Umsetzung dran. Prüfen Sie Ihre heutige Anwendung.", en: "If you have read the Word, now is the time to live it out. Check today's application." },
  home_next_step_decision_btn:  { ko: "오늘의 적용 보기",       de: "Heutige Anwendung ansehen", en: "View today's application" },
  home_next_step_complete_title:{ ko: "오늘도 믿음의 뿌리가 깊어지고 있어요.", de: "Heute wachsen die Wurzeln Ihres Glaubens tiefer.", en: "Today, the roots of your faith are growing deeper." },
  home_next_step_complete_sub:  { ko: "루츠맨이 정원에 물을 주고 있어요. 정원에서 오늘의 성장을 확인해보세요.", de: "RootsMan gießt gerade Ihren Garten. Sehen Sie sich das heutige Wachstum an.", en: "RootsMan is watering your garden. Take a look at today's growth." },
  home_next_step_complete_btn:  { ko: "정원 보기",             de: "Garten ansehen", en: "View garden" },
  ...
  home_apply_section:     { ko: "오늘의 적용",          de: "Heutige Anwendung", en: "Today's application" },
  home_apply_ai:          { ko: "추천 적용",            de: "Empfohlene Anwendung", en: "Recommended application" },
  home_apply_my:          { ko: "내가 적은 결단",        de: "Meine notierten Vorsätze", en: "My written resolutions" },
  ...
  home_prayer_quiet_celeb:{ ko: "오늘의 기도를 하나님께 드렸어요 🙏", de: "Sie haben Ihr heutiges Gebet Gott gebracht 🙏", en: "You offered today's prayer to God 🙏" },
  home_prayer_quiet_celeb_sub:{ ko: "조용한 기도도 귀한 루틴이에요.", de: "Auch ein stilles Gebet ist ein kostbarer Teil Ihrer Routine.", en: "Even a quiet prayer is a precious part of your routine." },
  ...
  home_qt_choice_title:{ ko: "오늘 QT를 어떻게 할까요?", de: "Wie möchten Sie heute QT machen?", en: "How would you like to do QT today?" },
  home_qt_choice_sub:  { ko: "오늘은 6단계 큐티를 추천해요. 부담된다면 자유형식으로 짧게 시작해도 괜찮아요.", de: "Heute empfehlen wir die 6-Schritte-QT. Wenn es zu viel ist, können Sie auch frei und kurz beginnen.", en: "We recommend the 6-step QT today. If that feels too much, you can start briefly in free form." },
  home_qt_choice_6step:{ ko: "6단계 큐티 시작하기", de: "6-Schritte-QT beginnen", en: "Start 6-step QT" },
  home_qt_choice_free: { ko: "자유형식으로 큐티하기", de: "Freie QT machen", en: "Do free-form QT" },
  home_qt_choice_guide:{ ko: "6단계 가이드 보기", de: "6-Schritte-Anleitung ansehen", en: "View 6-step guide" },
  home_qt_choice_close:{ ko: "닫기", de: "Schließen", en: "Close" },
  home_qt_sunday_title:{ ko: "오늘은 주일이에요 🙌", de: "Heute ist Sonntag 🙌", en: "Today is Sunday 🙌" },
  home_qt_sunday_sub:  { ko: "주일예배 말씀으로 QT를 진행해요.", de: "Machen Sie heute QT mit der Predigt und dem Bibeltext des Gottesdienstes.", en: "Use today’s worship sermon and passage for QT." },
  home_qt_sunday_start:{ ko: "주일예배 QT 시작하기", de: "Sonntagsgottesdienst-QT starten", en: "Start Sunday worship QT" },
  ...
  tree_sub_0:   { ko: "씨앗이 심어졌어요. 오늘부터 다시 함께 자라가요!", de: "Der Samen ist gepflanzt. Heute beginnt der Weg erneut!", en: "The seed has been planted. Let's begin growing again today!" },
  tree_sub_10:  { ko: "1일부터 10일까지, 작은 순종이 뿌리를 내리고 있어요.", de: "Tag 1 bis 10: Kleine Schritte schlagen Wurzeln.", en: "Days 1–10: small acts of faith are taking root." },
  tree_sub_20:  { ko: "11일부터 20일까지, 새싹이 또렷하게 자라나고 있어요.", de: "Tag 11 bis 20: Der Spross wächst sichtbar.", en: "Days 11–20: the new sprout is growing clearly." },
  tree_sub_30:  { ko: "21일부터 30일까지, 뿌리와 줄기가 함께 단단해지고 있어요.", de: "Tag 21 bis 30: Wurzeln und Stamm werden stärker.", en: "Days 21–30: roots and stem are growing stronger together." },
  tree_sub_40:  { ko: "31일부터 40일까지, 가지가 뻗으며 생명이 넓어지고 있어요.", de: "Tag 31 bis 40: Die Äste breiten sich aus.", en: "Days 31–40: branches are stretching out with life." },
  tree_sub_50:  { ko: "41일부터 50일까지, 나무가 눈에 띄게 자라고 있어요.", de: "Tag 41 bis 50: Der Baum wächst sichtbar weiter.", en: "Days 41–50: the tree is growing noticeably." },
  tree_sub_60:  { ko: "51일부터 60일까지, 정원이 더 풍성해지고 있어요.", de: "Tag 51 bis 60: Der Garten wird reicher.", en: "Days 51–60: the garden is becoming fuller." },
  tree_sub_70:  { ko: "61일부터 70일까지, 쉼과 그늘을 주는 나무로 자라가고 있어요.", de: "Tag 61 bis 70: Der Baum schenkt Ruhe und Schatten.", en: "Days 61–70: the tree is growing into a place of shade and rest." },
  tree_sub_80:  { ko: "71일부터 80일까지, 열매를 준비하는 계절로 들어가고 있어요.", de: "Tag 71 bis 80: Es ist Zeit, Frucht vorzubereiten.", en: "Days 71–80: you are entering a season of preparing fruit." },
  tree_sub_90:  { ko: "81일부터 90일까지, 정원이 거의 완성되어 가고 있어요.", de: "Tag 81 bis 90: Der Garten ist fast vollendet.", en: "Days 81–90: the garden is almost complete." },
  tree_sub_100: { ko: "91일부터 100일까지, 성령의 열매를 맺을 준비가 되었어요.", de: "Tag 91 bis 100: Sie sind bereit, Frucht des Geistes zu tragen.", en: "Days 91–100: you are ready to bear the fruit of the Spirit." },

  // ── RootsManPopup ──
  rootsman_title: { ko: "루츠맨이 물을 주고 있어요",     de: "RootsMan gießt den Garten", en: "RootsMan is watering the garden" },
  ...
  rootsman_msg_1: { ko: "씨앗이 땅속에서 뿌리를 내리기 시작했어요.", de: "Der Samen beginnt, Wurzeln zu schlagen.", en: "RootsMan is watering your seed today! 💧" },
  rootsman_msg_2: { ko: "새싹이 조금씩 고개를 내밀고 있어요.",       de: "Ein kleiner Sprössling zeigt sich.", en: "Your sprout gets love today! 🌱" },
  rootsman_msg_3: { ko: "묘목이 햇빛을 향해 자라고 있어요.",         de: "Der Setzling wächst zum Licht.", en: "Growing well! RootsMan is cheering you on! 🌿" },
  ...
  rootsman_msg_6: { ko: "말씀에 점점 더 깊이 뿌리를 내리고 있어요.", de: "Die Verwurzelung in Gottes Wort wird tiefer.", en: "RootsMan is smiling at your garden! 😊" },
