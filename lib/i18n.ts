...
export const T = {
  ...
  community_hide_content_confirm_msg: { ko: "숨기면 내 화면에서 이 글이 보이지 않아요. 다른 사람에게는 그대로 보일 수 있어요.", de: "Wenn Sie ihn ausblenden, sehen Sie diesen Beitrag nicht mehr. Andere können ihn möglicherweise weiterhin sehen.", en: "If you hide it, this post will no longer appear for you. Other people may still see it.", fr: "Si vous la masquez, cette publication ne s’affichera plus pour vous. D’autres personnes peuvent encore la voir." },
  ...
  community_hide_user_confirm_msg: { ko: "숨기면 내 화면에서 이 사용자의 글이 보이지 않아요. 상대방에게 알림은 가지 않아요.", de: "Wenn Sie sie ausblenden, sehen Sie Beiträge dieser Person nicht mehr. Die andere Person wird nicht benachrichtigt.", en: "If you hide them, posts from this user will no longer appear for you. They will not be notified.", fr: "Si vous les masquez, les publications de cette personne ne s’afficheront plus pour vous. Elle ne recevra pas de notification." },
