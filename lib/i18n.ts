...
export const T = {
  ...
  onboarding_desc4_sub: { ko: "기도 중 → 기도 응답으로\n하나님의 일하심을 기록해가요.", de: "Im Gebet → Erhörtes Gebet\nGottes Wirken aufzeichnen.", en: "From praying to answered prayer,\nkeep a record of how God is working.", fr: "De la prière à l’exaucement,\\ngardez une trace de l’œuvre de Dieu." },
