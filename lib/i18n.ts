...
export const T = {
  ...
  community_partner_empty_qt_body: { ko: "동역자에게 나눈 묵상은 다음 단계에서 이곳에 모아드릴게요.", de: "Mit Glaubenspartnern geteilte Stille Zeiten erscheinen im nächsten Schritt hier.", en: "Reflections shared with faith partners will appear here in the next step.", fr: "Les méditations partagées avec vos partenaires de foi apparaîtront ici à la prochaine étape." },
  community_partner_empty_praying_title: { ko: "아직 기도 중인 제목이 없어요", de: "Noch keine Gebetsanliegen", en: "No prayer requests yet", fr: "Aucun sujet de prière pour l’instant" },
  community_partner_empty_praying_body: { ko: "동역자에게 부탁한 기도 제목은 다음 단계에서 이곳에 모아드릴게요.", de: "Gebetsanliegen, die du mit Glaubenspartnern teilst, erscheinen im nächsten Schritt hier.", en: "Prayer requests shared with faith partners will appear here in the next step.", fr: "Les sujets de prière partagés avec vos partenaires de foi apparaîtront ici à la prochaine étape." },
  community_partner_empty_answered_title: { ko: "아직 기도 응답이 없어요", de: "Noch keine Gebetserhörungen", en: "No answered prayers yet", fr: "Aucune prière exaucée pour l’instant" },
  community_partner_empty_answered_body: { ko: "동역자와 함께 축하할 기도 응답은 다음 단계에서 이곳에 모아드릴게요.", de: "Erhörte Gebete, die du mit Glaubenspartnern teilen kannst, erscheinen im nächsten Schritt hier.", en: "Answered prayers shared with faith partners will appear here in the next step.", fr: "Les prières exaucées partagées avec vos partenaires de foi apparaîtront ici à la prochaine étape." },
