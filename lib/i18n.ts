...
export const T = {
  ...
  prayer_sub_line2: { ko: "중보 기도를 커뮤니티에 요청도 하시고, 응답됐을 때 짧은 간증도 남겨보세요.", de: "Bitten Sie die Community um Fürbitte und halten Sie bei einer Gebetserhörung ein kurzes Zeugnis fest.", en: "Ask the community to pray with you, and when God answers, leave a short testimony.", fr: "Demandez l’intercession à la communauté et, lorsqu’une prière est exaucée, laissez un court témoignage." },
  prayer_sub_line3: { ko: "하나님이 이루시는 일들을 경험할 수 있답니다.", de: "So können Sie erleben, was Gott tut.", en: "You may experience the things God is doing.", fr: "Vous pourrez ainsi voir ce que Dieu accomplit." },
  ...
  prayer_intercession_share_sub: { ko: "전체 커뮤니티와 내 그룹 중 어디에 기도 제목을 나눌지 선택해주세요. 여러 곳을 선택할 수 있어요.", de: "Wählen Sie aus, wo Sie dieses Gebetsanliegen teilen möchten: in der ganzen Community oder in Ihren Gruppen. Mehrfachauswahl ist möglich.", en: "Choose where to share this prayer request: the whole community or your groups. You can select more than one.", fr: "Choisissez où partager ce sujet de prière : dans toute la communauté ou dans vos groupes. Vous pouvez en choisir plusieurs." },
