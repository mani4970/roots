...
export const T = {
  ...
  community_manage_qt_unshare_msg: { ko: "이 큐티 나눔을 커뮤니티와 그룹에서 내릴게요. 내 큐티 기록은 삭제되지 않아요.", de: "Dieses geteilte QT wird aus der Community und den Gruppen entfernt. Ihr eigener QT-Eintrag wird nicht gelöscht.", en: "This QT will be removed from the community and groups. Your own QT record will not be deleted.", fr: "Ce QT sera retiré de la communauté et des groupes. Votre propre journal QT ne sera pas supprimé." },
  ...
  community_manage_prayer_unshare_msg: { ko: "이 중보기도 요청을 커뮤니티와 그룹에서 내릴게요. 내 기도 기록은 삭제되지 않아요.", de: "Diese Fürbitte-Anfrage wird aus der Community und den Gruppen entfernt. Ihr eigener Gebetseintrag wird nicht gelöscht.", en: "This prayer request will be removed from the community and groups. Your own prayer record will not be deleted.", fr: "Cette demande d’intercession sera retirée de la communauté et des groupes. Votre propre prière ne sera pas supprimée." },
