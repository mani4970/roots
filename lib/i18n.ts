...
export const T = {
  ...
  home_routine_open: { ko: "열기 →",              de: "Öffnen →", en: "Open →", fr: "Ouvrir →" },
    ...
    qt_passage_choice_sub:  { ko: "오늘의 본문을 따라가거나, 마음에 주신 말씀을 직접 선택할 수 있어요.", de: "Sie können dem heutigen Abschnitt folgen oder selbst einen Abschnitt auswählen.", en: "Follow today’s passage, or choose a passage God has placed on your heart.", fr: "Suivez le passage du jour ou choisissez vous-même un passage à méditer." },
    ...
    qt_passage_choice_today_desc:{ ko: "Roots가 준비한 오늘의 말씀으로 6단계 큐티를 해요.", de: "Machen Sie die 6-Schritte-QT mit dem heutigen Roots-Abschnitt.", en: "Do the 6-step QT with today’s Roots passage.", fr: "Faites le QT en 6 étapes avec le passage Roots du jour." },
    qt_passage_choice_custom:{ ko: "본문 직접 선택하기", de: "Abschnitt selbst auswählen", en: "Choose a passage", fr: "Choisir un passage" },
    qt_passage_choice_custom_desc:{ ko: "묵상하고 싶은 말씀을 직접 골라 6단계로 큐티해요.", de: "Wählen Sie selbst einen Abschnitt und gehen Sie ihn in 6 Schritten durch.", en: "Pick the passage you want to meditate on, then follow the 6 steps.", fr: "Choisissez le passage à méditer, puis suivez les 6 étapes." },
