...
const BACKGROUND_NAMES: Record<ProfileCharacterLang, readonly string[]> = {
  ko: ["햇살 정원", "여름 바다", "포근한 책방", "노을빛 도시 옥상", "라벤더 별빛 밤", "고요한 교회", "스위스 알프스", "파리 에펠탑", "뉴욕 항구", "서울 한강", "런던 템스강", "산토리니 바다", "아프리카 초원", "시드니 항구", "예수님과 사진 찍기", "일본", "나는 예수님의 13번째 제자", "독일", "스페인"],
  en: ["Sunlit Garden", "Summer Beach", "Cozy Bookroom", "Sunset City Rooftop", "Lavender Starry Night", "Peaceful Church", "Swiss Alps", "Paris Eiffel Tower", "New York Harbor", "Seoul Han River", "London Thames", "Santorini Sea", "African Savanna", "Sydney Harbour", "Photo with Jesus", "Japan", "I Am Jesus’ 13th Disciple", "Germany", "Spain"],
