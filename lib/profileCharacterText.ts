...
const BACKGROUND_NAMES: Record<ProfileCharacterLang, readonly string[]> = {
  ko: ["햇살 정원", "여름 바다", "포근한 책방", "노을빛 도시 옥상", "라벤더 별빛 밤", "고요한 교회", "스위스 알프스", "파리 에펠탑", "뉴욕 항구", "서울 한강", "런던 템스강", "산토리니 바다", "아프리카 초원", "시드니 항구", "예수님과 사진 찍기", "일본"],
  en: ["Sunlit Garden", "Summer Beach", "Cozy Bookroom", "Sunset City Rooftop", "Lavender Starry Night", "Peaceful Church", "Swiss Alps", "Paris Eiffel Tower", "New York Harbor", "Seoul Han River", "London Thames", "Santorini Sea", "African Savanna", "Sydney Harbour", "Photo with Jesus", "Japan"],
  ...
  es: ["Jardín soleado", "Playa de verano", "Sala de lectura acogedora", "Azotea urbana al atardecer", "Noche estrellada lavanda", "Iglesia tranquila", "Alpes suizos", "Torre Eiffel de París", "Puerto de Nueva York", "Río Han de Seúl", "Río Támesis de Londres", "Mar de Santorini", "Sabana africana", "Puerto de Sídney", "Foto con Jesús", "Japón"],
};
...
const ITEM_NAMES: Record<ProfileCharacterLang, ItemNames> = {
  ko: {
    rootsman: {
      ...
      top: ["오트밀 GRACE 맨투맨", "파우더 GOD IS GOOD 니트", "차콜 AMEN 후디", "세이지 JESUS IS LOVE 티", "네이비 십자가 폴로", "아이보리 캠프 셔츠", "오트밀 오픈 린넨 셔츠", "스카이 캠프 칼라 셔츠", "세이지 니트 오픈 폴로", "워시드 차콜 JESUS 티", "머스타드 케이블 니트 폴로", "버건디 크림 럭비 셔츠", "네이비 콘트라스트 워크 셔츠", "네이비 베이지 하프집업 아노락"],
      bag: [],
    ...
    rootswoman: {
      pet: ["슈나우저", "비숑 프리제", "러시안 블루", "페르시안 고양이", "동키", "치치", "열무"],
      bottom: ["차콜 플리츠 미니스커트", "연청 테일러드 쇼츠", "아이보리 랩 미니스커트", "블랙 세미와이드 슬랙스", "다크 인디고 부츠컷 데님", "딥 네이비 맥시스커트", "크림 플리츠 와이드 팬츠", "블랙 슬림 카프리 팬츠", "스카이 돌핀 쇼츠", "아이보리 레이스 맥시스커트", "베리 핑크 턴업 쇼츠", "올리브 카고 버뮤다", "모카 브라운 스트링 쇼츠", "버터 옐로 도트 미디스커트"],
      shoes: ["아이보리 핑크 레트로 스니커즈", "블랙 더블 스트랩 메리제인", "실버 라일락 러너", "버건디 페니 로퍼", "스카이 블루 레트로 스니커즈", "아이보리 메쉬 메리제인", "브라운 피셔맨 샌들", "버터 옐로 티스트랩 메리제인"],
      top: ["워시드 네이비 JESUS LOVES ME 티", "코랄 AMEN 카디건", "세이지 GOD IS GOOD 니트", "오트밀 하트 후디", "라벤더 JESUS 폴로", "차콜 GRACE 맨투맨", "아이보리 레이스 레이어드 블라우스", "버터 옐로 로맨틱 블라우스", "네이비 블록코어 풋볼 저지", "워시드 데님 크롭 베스트 레이어드", "스카이 블루 벨티드 셔츠 원피스", "네이비 피터팬 칼라 원피스", "스카이 블루 랩 리본 블라우스", "코랄 플라워 페플럼 블라우스", "아이보리 퍼프 블라우스", "블루 니트 칼라 톱", "핑크 리본 티", "베이지 더블 버튼 재킷"],
  ...
  en: {
    ...
    rootswoman: {
      pet: ["Schnauzer", "Bichon Frise", "Russian Blue", "Persian Cat", "Donki", "Chichi", "Yeolmu"],
      bottom: ["Charcoal Pleated Mini", "Light-Wash Tailored Shorts", "Ivory Wrap Mini", "Black Semi-Wide Slacks", "Dark Indigo Bootcut Denim", "Deep Navy Maxi Skirt", "Cream Pleated Wide Pants", "Black Slim Capri Pants", "Sky Blue Dolphin Shorts", "Ivory Lace Maxi Skirt", "Berry Pink Turn-Up Shorts", "Olive Cargo Bermudas", "Mocha Brown Drawstring Shorts", "Butter Yellow Polka-Dot Midi Skirt"],
  ...
  de: {
    rootsman: {
      ...
      top: ["GRACE-Sweatshirt in Oatmeal", "GOD IS GOOD Strickpullover", "AMEN-Hoodie in Anthrazit", "JESUS IS LOVE Shirt in Salbei", "Marineblaues Kreuz-Polo", "Elfenbeinfarbenes Camp-Shirt", "Offenes Leinenhemd in Oatmeal", "Himmelblaues Camp-Kragen-Hemd", "Offenes Strickpolo in Salbei", "Verwaschenes JESUS-Shirt in Anthrazit", "Senfgelbes Kabelstrick-Polo", "Burgunder-Creme Rugbyshirt", "Marineblaues Kontrast-Workshirt", "Marineblau-beiger Half-Zip-Anorak"],
      bag: [],
