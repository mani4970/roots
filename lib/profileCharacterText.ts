...
const ITEM_NAMES: Record<ProfileCharacterLang, ItemNames> = {
  ko: {
    ...
    rootswoman: {
      ...
      top: ["워시드 네이비 JESUS LOVES ME 티", "코랄 AMEN 카디건", "세이지 GOD IS GOOD 니트", "오트밀 하트 후디", "라벤더 JESUS 폴로", "차콜 GRACE 맨투맨", "아이보리 레이스 레이어드 블라우스", "버터 옐로 로맨틱 블라우스", "네이비 블록코어 풋볼 저지", "워시드 데님 크롭 베스트 레이어드", "스카이 블루 벨티드 셔츠 원피스", "네이비 피터팬 칼라 원피스", "스카이 블루 랩 리본 블라우스", "코랄 플라워 페플럼 블라우스", "아이보리 퍼프 블라우스", "블루 니트 칼라 톱", "핑크 리본 티", "베이지 더블 버튼 재킷", "브라운 크롭 재킷 리본 블라우스", "차콜 크롭 카디건 퍼플 니트", "블랙 크롭 봄버 버건디 니트", "크림 케이블 카디건 스트라이프 셔츠"],
