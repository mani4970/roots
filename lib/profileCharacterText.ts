...
const ITEM_NAMES: Record<ProfileCharacterLang, ItemNames> = {
  ...
  en: {
    rootsman: {
      ...
      top: ["Oatmeal GRACE Sweatshirt", "Powder GOD IS GOOD Knit", "Charcoal AMEN Hoodie", "Sage JESUS IS LOVE Tee", "Navy Cross Polo", "Ivory Camp Shirt", "Oatmeal Open Linen Shirt", "Sky Camp-Collar Shirt", "Sage Knit Open Polo", "Washed Charcoal JESUS Tee", "Mustard Cable-Knit Polo", "Burgundy Cream Rugby Shirt", "Navy Contrast Work Shirt", "Navy Beige Half-Zip Anorak", "Camel Suede Blouson", "Deep Olive Knit Zip-Up", "Washed Charcoal Trucker Jacket", "Burgundy Argyle Knit Vest", "Sand Field Jacket & Navy Knit", "Dark Brown Suede Jacket & Oatmeal Knit", "Navy Double-Breasted Peacoat", "Dusty Blue Work Jacket & Ivory Henley"],
      bag: [],
