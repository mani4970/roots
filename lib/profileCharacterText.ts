...
const ITEM_NAMES: Record<ProfileCharacterLang, ItemNames> = {
  ko: {
    ...
    rootswoman: {
      ...
      bag: ["", "버건디 미니 크로스백", "블랙 스트럭처드 핸드백", "아이보리 미니 보스턴백"],
  ...
  en: {
    ...
    rootswoman: {
      ...
      bag: ["", "Burgundy Mini Crossbody", "Black Structured Handbag", "Ivory Mini Boston Bag"],
  ...
  de: {
    ...
    rootswoman: {
      ...
      bag: ["", "Burgunderrote Mini-Umhängetasche", "Schwarze strukturierte Handtasche", "Elfenbeinfarbene Mini-Boston-Tasche"],
  ...
  fr: {
    ...
    rootswoman: {
      ...
      bag: ["", "Mini sac bandoulière bordeaux", "Sac à main structuré noir", "Mini sac Boston ivoire"],
