...
type ItemNames = Record<RootsAvatarType, Record<WearableCharacterSlot, readonly (string | null)[]>>;
...
// Retired numeric IDs keep a null placeholder so later background names do not shift.
const BACKGROUND_NAMES: Record<ProfileCharacterLang, readonly (string | null)[]> = {
  ko: ["햇살 정원", "여름 바다", "포근한 책방", "노을빛 도시 옥상", "라벤더 별빛 밤", "고요한 교회", "스위스 알프스", "파리 에펠탑", "뉴욕 항구", "서울 한강", "런던 템스강", "산토리니 바다", "아프리카 초원", "시드니 항구", "예수님과 사진 찍기", "일본", "나는 예수님의 13번째 제자", "독일", "스페인", "부산", null, "제주도", "노르웨이 오로라", "스위스 겨울 마을", "베네치아", "돌로미티", "퀘벡", "그랜드 캐니언"],
  en: ["Sunlit Garden", "Summer Beach", "Cozy Bookroom", "Sunset City Rooftop", "Lavender Starry Night", "Peaceful Church", "Swiss Alps", "Paris Eiffel Tower", "New York Harbor", "Seoul Han River", "London Thames", "Santorini Sea", "African Savanna", "Sydney Harbour", "Photo with Jesus", "Japan", "I Am Jesus’ 13th Disciple", "Germany", "Spain", "Busan", null, "Jeju Island", "Norway Aurora", "Swiss Winter Village", "Venice", "Dolomites", "Quebec City", "Grand Canyon"],
  de: ["Sonniger Garten", "Sommerstrand", "Gemütliches Bücherzimmer", "Dachterrasse bei Sonnenuntergang", "Lavendelfarbene Sternennacht", "Ruhiger Kirchenraum", "Schweizer Alpen", "Pariser Eiffelturm", "New Yorker Hafen", "Han-Fluss in Seoul", "Themse in London", "Santorini am Meer", "Afrikanische Savanne", "Hafen von Sydney", "Foto mit Jesus", "Japan", "Ich bin Jesu 13. Jünger", "Deutschland", "Spanien", "Busan", null, "Insel Jeju", "Nordlicht in Norwegen", "Schweizer Winterdorf", "Venedig", "Dolomiten", "Québec", "Grand Canyon"],
  fr: ["Jardin ensoleillé", "Plage d’été", "Bibliothèque chaleureuse", "Toit urbain au coucher du soleil", "Nuit étoilée lavande", "Église paisible", "Alpes suisses", "Tour Eiffel à Paris", "Port de New York", "Fleuve Han à Séoul", "Tamise à Londres", "Mer de Santorin", "Savane africaine", "Port de Sydney", "Photo avec Jésus", "Japon", "Je suis le 13e disciple de Jésus", "Allemagne", "Espagne", "Busan", null, "Île de Jeju", "Aurore boréale en Norvège", "Village suisse en hiver", "Venise", "Dolomites", "Québec", "Grand Canyon"],

  es: ["Jardín soleado", "Playa de verano", "Sala de lectura acogedora", "Azotea urbana al atardecer", "Noche estrellada lavanda", "Iglesia tranquila", "Alpes suizos", "Torre Eiffel de París", "Puerto de Nueva York", "Río Han de Seúl", "Río Támesis de Londres", "Mar de Santorini", "Sabana africana", "Puerto de Sídney", "Foto con Jesús", "Japón", "Soy el 13.º discípulo de Jesús", "Alemania", "España", "Busan", null, "Isla de Jeju", "Aurora boreal de Noruega", "Pueblo suizo en invierno", "Venecia", "Dolomitas", "Quebec", "Gran Cañón"],
};

const ITEM_NAMES: Record<ProfileCharacterLang, ItemNames> = {
  ko: {
    rootsman: {
      pet: ["슈나우저", "비숑 프리제", "러시안 블루", "페르시안 고양이", "동키", "치치", "열무", "웰시코기", "닥스훈트"],
      bottom: ["차콜 원턱 버뮤다", "연청 데님 버뮤다", "올리브 카고 쇼츠", "블랙 와이드 슬랙스", "에크루 스트레이트 치노", "인디고 와이드 데님", "라이트 워시 와이드 데님", "차콜 핀스트라이프 버뮤다", "워시드 블랙 와이드 데님", "올리브 와이드 카고 팬츠", "브라운 원턱 버뮤다", "차콜 워크 와이드 팬츠", "네이비 파이핑 스포츠 쇼츠", "샌드 베이지 카고 팬츠", null, "차콜 체크 와이드 팬츠", "네이비 테크 카고 조거 팬츠", null, "아이보리 원턱 와이드 슬랙스", "차콜 투턱 와이드 슬랙스", "네이비 사이드 어드저스터 슬랙스", "토프 투턱 와이드 슬랙스"],
      shoes: ["레트로 스니커즈", "실버 그레이 러너", "블랙 청키 로퍼", "새싹 하트 샌드 클로그", "브라운 보트 슈즈", "다크 브라운 페니 로퍼", "블랙 피셔맨 샌들", "세이지 레트로 러너", "버건디 크림 레트로 스니커즈", "토프 버클 스웨이드 클로그", "네이비 아이보리 하이탑 스니커즈", "코냑 스웨이드 첼시부츠"],
      top: ["오트밀 GRACE 맨투맨", "파우더 GOD IS GOOD 니트", "차콜 AMEN 후디", "세이지 JESUS IS LOVE 티", "네이비 십자가 폴로", "아이보리 캠프 셔츠", "오트밀 오픈 린넨 셔츠", "스카이 캠프 칼라 셔츠", "세이지 니트 오픈 폴로", "워시드 차콜 JESUS 티", "머스타드 케이블 니트 폴로", "버건디 크림 럭비 셔츠", "네이비 콘트라스트 워크 셔츠", "네이비 베이지 하프집업 아노락", "카멜 스웨이드 블루종", "딥 올리브 니트 집업", "워시드 차콜 트러커 재킷", "버건디 아가일 니트 베스트", "샌드 필드 재킷 네이비 니트", "다크 브라운 스웨이드 재킷 오트밀 니트", "네이비 더블 브레스티드 피코트", "더스티 블루 워크 재킷 아이보리 헨리넥", "버건디 풀오버 후디", "헤더 그레이 집업 후디", "샌드 베이지 벨티드 트렌치코트", "올리브 하프집 아노락"],
      bag: [],
    ...
    rootswoman: {
      ...
      shoes: ["아이보리 핑크 레트로 스니커즈", "블랙 더블 스트랩 메리제인", "실버 라일락 러너", "버건디 페니 로퍼", "스카이 블루 레트로 스니커즈", "아이보리 메쉬 메리제인", "브라운 피셔맨 샌들", "버터 옐로 티스트랩 메리제인", "코냑 셔링 부츠", "블랙 레이스업 앵클부츠", "플럼 포인티드 펌프스", "딥 그린 리본 발레리나 플랫"],
  ...
  en: {
    rootsman: {
      pet: ["Schnauzer", "Bichon Frise", "Russian Blue", "Persian Cat", "Donki", "Chichi", "Yeolmu", "Welsh Corgi", "Dachshund"],
      bottom: ["Charcoal Bermuda Shorts", "Light-Wash Denim Bermudas", "Olive Cargo Shorts", "Black Wide Slacks", "Ecru Straight Chinos", "Indigo Wide Denim", "Light-Wash Wide Denim", "Charcoal Pinstripe Bermudas", "Washed Black Wide Denim", "Olive Wide Cargo Pants", "Brown Pleated Bermudas", "Charcoal Wide Work Pants", "Navy Piped Sport Shorts", "Sand Beige Cargo Pants", null, "Charcoal Plaid Wide Pants", "Navy Tech Cargo Joggers", null, "Ivory One-Pleat Wide Trousers", "Charcoal Double-Pleat Wide Trousers", "Navy Side-Adjuster Trousers", "Taupe Double-Pleat Wide Trousers"],
      shoes: ["Retro Sneakers", "Silver Gray Runners", "Black Chunky Loafers", "Sprout Heart Sand Clogs", "Brown Boat Shoes", "Dark Brown Penny Loafers", "Black Fisherman Sandals", "Sage Retro Runners", "Burgundy Cream Retro Sneakers", "Taupe Buckle Suede Clogs", "Navy Ivory High-Top Sneakers", "Cognac Suede Chelsea Boots"],
      top: ["Oatmeal GRACE Sweatshirt", "Powder GOD IS GOOD Knit", "Charcoal AMEN Hoodie", "Sage JESUS IS LOVE Tee", "Navy Cross Polo", "Ivory Camp Shirt", "Oatmeal Open Linen Shirt", "Sky Camp-Collar Shirt", "Sage Knit Open Polo", "Washed Charcoal JESUS Tee", "Mustard Cable-Knit Polo", "Burgundy Cream Rugby Shirt", "Navy Contrast Work Shirt", "Navy Beige Half-Zip Anorak", "Camel Suede Blouson", "Deep Olive Knit Zip-Up", "Washed Charcoal Trucker Jacket", "Burgundy Argyle Knit Vest", "Sand Field Jacket & Navy Knit", "Dark Brown Suede Jacket & Oatmeal Knit", "Navy Double-Breasted Peacoat", "Dusty Blue Work Jacket & Ivory Henley", "Burgundy Pullover Hoodie", "Heather Gray Zip-Up Hoodie", "Sand Beige Belted Trench Coat", "Olive Half-Zip Anorak"],
      bag: [],
    ...
    rootswoman: {
      ...
      shoes: ["Ivory Pink Retro Sneakers", "Black Double-Strap Mary Janes", "Silver Lilac Runners", "Burgundy Penny Loafers", "Sky Blue Retro Sneakers", "Ivory Mesh Mary Janes", "Brown Fisherman Sandals", "Butter Yellow T-Strap Mary Janes", "Cognac Slouch Boots", "Black Lace-Up Ankle Boots", "Plum Pointed Pumps", "Deep Green Bow Ballet Flats"],
  ...
  de: {
    rootsman: {
      pet: ["Schnauzer", "Bichon Frisé", "Russisch Blau", "Perserkatze", "Donki", "Chichi", "Yeolmu", "Welsh Corgi", "Dackel"],
      bottom: ["Anthrazit-Bermudas", "Helle Denim-Bermudas", "Olivgrüne Cargo-Shorts", "Schwarze weite Hose", "Ecru-Chinos", "Weite Indigo-Jeans", "Helle Wide-Leg-Jeans", "Anthrazitfarbene Nadelstreifen-Bermudas", "Verwaschene schwarze Wide-Leg-Jeans", "Olivgrüne weite Cargohose", "Braune Bundfalten-Bermudas", "Anthrazitfarbene weite Workwear-Hose", "Marineblaue Sportshorts mit Paspeln", "Sandbeige Cargohose", null, "Anthrazitfarbene karierte Wide-Leg-Hose", "Marineblaue Tech-Cargo-Jogginghose", null, "Elfenbeinfarbene Wide-Leg-Hose mit Bundfalte", "Anthrazitfarbene Wide-Leg-Hose mit zwei Bundfalten", "Marineblaue Hose mit seitlichen Verstellriegeln", "Taupefarbene Wide-Leg-Hose mit zwei Bundfalten"],
      shoes: ["Retro-Sneaker", "Silbergraue Laufschuhe", "Schwarze Chunky-Loafer", "Sand-Clogs mit Herz", "Braune Bootsschuhe", "Dunkelbraune Pennyloafer", "Schwarze Fisherman-Sandalen", "Retro-Sneaker in Salbei", "Burgunder-cremefarbene Retro-Sneaker", "Taupefarbene Wildleder-Clogs mit Schnalle", "Marine-elfenbeinfarbene High-Top-Sneaker", "Cognacfarbene Wildleder-Chelsea-Boots"],
      top: ["GRACE-Sweatshirt in Oatmeal", "GOD IS GOOD Strickpullover", "AMEN-Hoodie in Anthrazit", "JESUS IS LOVE Shirt in Salbei", "Marineblaues Kreuz-Polo", "Elfenbeinfarbenes Camp-Shirt", "Offenes Leinenhemd in Oatmeal", "Himmelblaues Camp-Kragen-Hemd", "Offenes Strickpolo in Salbei", "Verwaschenes JESUS-Shirt in Anthrazit", "Senfgelbes Kabelstrick-Polo", "Burgunder-Creme Rugbyshirt", "Marineblaues Kontrast-Workshirt", "Marineblau-beiger Half-Zip-Anorak", "Kamelbrauner Wildleder-Blouson", "Dunkeloliver Strickcardigan mit Reißverschluss", "Anthrazitfarbene Truckerjacke im Washed-Look", "Burgunderroter Argyle-Strickpullunder", "Sandfarbene Fieldjacket mit marineblauem Strickpullover", "Dunkelbraune Wildlederjacke mit cremefarbenem Strickpullover", "Marineblauer zweireihiger Peacoat", "Staublaue Workwear-Jacke mit elfenbeinfarbenem Henleyshirt", "Burgunderroter Pullover-Hoodie", "Mélangegrauer Zip-Hoodie", "Sandbeiger Trenchcoat mit Gürtel", "Olivgrüner Half-Zip-Anorak"],
      bag: [],
    ...
    rootswoman: {
      ...
      shoes: ["Retro-Sneaker in Elfenbeinrosa", "Schwarze Mary Janes", "Silber-lilafarbene Laufschuhe", "Burgunderfarbene Pennyloafer", "Himmelblaue Retro-Sneaker", "Elfenbeinfarbene Mesh-Mary-Janes", "Braune Fisherman-Sandalen", "Buttergelbe Mary Janes mit T-Riemen", "Cognacfarbene Slouch-Boots", "Schwarze Schnürstiefeletten", "Pflaumenfarbene spitze Pumps", "Dunkelgrüne Ballerinas mit Schleife"],
  ...
  fr: {
    rootsman: {
      pet: ["Schnauzer", "Bichon frisé", "Bleu russe", "Chat persan", "Donki", "Chichi", "Yeolmu", "Welsh Corgi", "Teckel"],
      bottom: ["Bermuda anthracite", "Bermuda en denim clair", "Short cargo olive", "Pantalon large noir", "Chino droit écru", "Jean large indigo", "Jean large bleu clair délavé", "Bermuda anthracite à fines rayures", "Jean large noir délavé", "Pantalon cargo large olive", "Bermuda marron à plis", "Pantalon de travail large anthracite", "Short de sport marine à passepoils", "Pantalon cargo beige sable", null, "Pantalon large à carreaux anthracite", "Jogging cargo technique bleu marine", null, "Pantalon large ivoire à un pli", "Pantalon large anthracite à deux plis", "Pantalon marine à pattes de réglage latérales", "Pantalon large taupe à deux plis"],
      shoes: ["Baskets rétro", "Baskets argent et gris", "Mocassins noirs épais", "Sabots sable cœur et pousse", "Chaussures bateau marron", "Mocassins penny brun foncé", "Sandales pêcheur noires", "Baskets rétro sauge", "Baskets rétro bordeaux et crème", "Sabots en daim taupe à boucle", "Baskets montantes bleu marine et ivoire", "Bottines Chelsea en daim cognac"],
      top: ["Sweat GRACE avoine", "Pull GOD IS GOOD poudré", "Sweat à capuche AMEN anthracite", "T-shirt JESUS IS LOVE sauge", "Polo croix marine", "Chemise camp ivoire", "Chemise ouverte en lin avoine", "Chemise col cubain bleu ciel", "Polo ouvert en maille sauge", "T-shirt JESUS anthracite délavé", "Polo en maille torsadée moutarde", "Maillot de rugby bordeaux et crème", "Chemise de travail marine contrastée", "Anorak demi-zip marine et beige", "Blouson en daim camel", "Gilet zippé en maille olive foncé", "Veste trucker anthracite délavée", "Pull sans manches argyle bordeaux", "Veste saharienne sable et pull marine", "Veste en daim brun foncé et pull avoine", "Caban croisé bleu marine", "Veste de travail bleu poudré et henley ivoire", "Sweat à capuche bordeaux", "Sweat zippé à capuche gris chiné", "Trench beige sable ceinturé", "Anorak olive à demi-zip"],
      bag: [],
    ...
    rootswoman: {
      ...
      shoes: ["Baskets rétro ivoire et rose", "Mary Janes noires à double bride", "Baskets argent et lilas", "Mocassins bordeaux", "Baskets rétro bleu ciel", "Mary Janes ivoire en résille", "Sandales pêcheur brunes", "Mary Janes jaune beurre à bride en T", "Bottes souples cognac", "Bottines noires à lacets", "Escarpins pointus prune", "Ballerines vert foncé à nœud"],
  ...
  es: {
    ...
    rootswoman: {
      ...
      shoes: ["Tenis retro marfil y rosa", "Mary Janes negras de doble correa", "Tenis runner plata y lila", "Mocasines penny borgoña", "Tenis retro celestes", "Mary Janes de malla marfil", "Sandalias pescador marrones", "Mary Janes amarillas con correa en T", "Botas fruncidas color coñac", "Botines negros con cordones", "Zapatos de tacón en punta color ciruela", "Bailarinas verde oscuro con lazo"],
