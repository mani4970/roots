...
const ITEM_NAMES: Record<ProfileCharacterLang, ItemNames> = {
  ko: {
    rootsman: {
      ...
      bottom: ["차콜 원턱 버뮤다", "연청 데님 버뮤다", "올리브 카고 쇼츠", "블랙 와이드 슬랙스", "에크루 스트레이트 치노", "인디고 와이드 데님", "라이트 워시 와이드 데님", "차콜 핀스트라이프 버뮤다", "워시드 블랙 와이드 데님", "올리브 와이드 카고 팬츠", "브라운 원턱 버뮤다", "차콜 워크 와이드 팬츠", "네이비 파이핑 스포츠 쇼츠", "샌드 베이지 카고 팬츠", "버건디 코듀로이 와이드 팬츠", "차콜 체크 와이드 팬츠", "네이비 테크 카고 조거 팬츠", "토프 벨티드 테이퍼드 팬츠"],
  ...
  en: {
    rootsman: {
      ...
      bottom: ["Charcoal Bermuda Shorts", "Light-Wash Denim Bermudas", "Olive Cargo Shorts", "Black Wide Slacks", "Ecru Straight Chinos", "Indigo Wide Denim", "Light-Wash Wide Denim", "Charcoal Pinstripe Bermudas", "Washed Black Wide Denim", "Olive Wide Cargo Pants", "Brown Pleated Bermudas", "Charcoal Wide Work Pants", "Navy Piped Sport Shorts", "Sand Beige Cargo Pants", "Burgundy Corduroy Wide Pants", "Charcoal Plaid Wide Pants", "Navy Tech Cargo Joggers", "Taupe Belted Tapered Pants"],
