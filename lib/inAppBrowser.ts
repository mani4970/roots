...
export function inAppBrowserText(lang: Lang) {
  const copy = {
    ko: {
      ...
      body: "카카오톡 같은 앱 안에서는 소셜 로그인이 차단될 수 있어요. Safari나 Chrome에서 다시 열면 정상적으로 로그인할 수 있습니다.",
    ...
    de: {
      ...
      body: "In In-App-Browsern wie KakaoTalk kann die Social-Anmeldung blockiert werden. Öffnen Sie Roots in Safari oder Chrome, um sich anzumelden.",
    ...
    en: {
      ...
      body: "Social sign-in can be blocked inside in-app browsers like KakaoTalk. Open Roots in Safari or Chrome to sign in safely.",
    ...
    fr: {
      ...
      body: "La connexion sociale peut être bloquée dans les navigateurs intégrés comme KakaoTalk. Ouvrez Roots dans Safari ou Chrome pour vous connecter.",
