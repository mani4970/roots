  ...
  return (
    <div
      ...
      style={{
        ...
        background: "rgba(26,28,30,0.65)", backdropFilter: "blur(6px)",
        paddingBottom: 90,
      }}
    >
      <div
      ...
      >
        ...
        <h3 style={{ fontSize: 18, fontWeight: 800, color: "var(--text)", marginBottom: 10 }}>
          {msg.title}
        </h3>
        <div style={{
          padding: "12px 14px", background: "var(--sage-light)",
          borderRadius: 14, border: "1px solid rgba(122,157,122,0.3)", marginBottom: 16,
        }}>
          <p style={{ fontSize: 13, color: "var(--sage-dark)", lineHeight: 1.8, whiteSpace: "pre-line" }}>
            {msg.sub}
          </p>
        </div>
        <button
