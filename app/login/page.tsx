...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", padding: "calc(136px + env(safe-area-inset-top)) 24px 40px", position: "relative" }}>
      ...
      <Link href={withRedirect("/welcome")} style={{ display: "flex", alignItems: "center", gap: 4, color: "var(--text3)", marginBottom: 24, position: "absolute", top: "calc(84px + env(safe-area-inset-top))", left: 22 }}>
