...
const PHOTO_COPY = {
  title: { ko: "사진으로 묵상 기록하기", de: "Stille Zeit mit Foto festhalten", en: "Record a Photo Bible Reflection", fr: "Enregistrer une méditation biblique en photo" },
  sub: { ko: "책이나 노트에 묵상한 내용을 사진으로 남겨요.", de: "Speichere deine handschriftliche Stille Zeit als Foto.", en: "Save a photo of your Bible Reflection from a book or notebook.", fr: "Gardez une photo de votre méditation biblique écrite dans un livre ou un carnet." },
  editTitle: { ko: "사진 묵상 수정하기", de: "Stille Zeit mit Foto bearbeiten", en: "Edit Photo Bible Reflection", fr: "Modifier la méditation biblique en photo" },
  editSub: { ko: "사진과 기록 내용을 안전하게 수정할 수 있어요.", de: "Du kannst das Foto und den Eintrag sicher bearbeiten.", en: "Safely update the photo and Bible Reflection details.", fr: "Modifiez en toute sécurité la photo et les détails de la méditation biblique." },
  passage: { ko: "묵상 본문", de: "Bibelstelle", en: "Passage", fr: "Passage" },
  todayOnly: { ko: "사진 묵상은 오늘 날짜의 말씀 묵상으로 저장됩니다.", de: "Die Stille Zeit mit Foto wird für heute gespeichert.", en: "A Photo Bible Reflection is saved as today's Bible Reflection.", fr: "La méditation biblique en photo est enregistrée pour aujourd’hui." },
  ...
  editLoading: { ko: "사진 묵상 기록을 불러오고 있어요…", de: "Die Stille Zeit mit Foto wird geladen…", en: "Loading the Photo Bible Reflection…", fr: "Chargement de la méditation biblique en photo…" },
  editLoadError: { ko: "수정할 사진 묵상 기록을 불러오지 못했어요.", de: "Die Stille Zeit mit Foto konnte nicht geladen werden.", en: "Could not load the Photo Bible Reflection to edit.", fr: "Impossible de charger la méditation biblique en photo à modifier." },
  ...
  editSaved: { ko: "사진 묵상 수정 내용을 저장했어요.", de: "Die Änderungen wurden gespeichert.", en: "Photo Bible Reflection changes saved.", fr: "Les modifications ont été enregistrées." },
  ...
  saveError: { ko: "사진 묵상 저장에 실패했어요. 다시 시도해주세요.", de: "Die Stille Zeit mit Foto konnte nicht gespeichert werden. Bitte versuche es erneut.", en: "Could not save the Photo Bible Reflection. Please try again.", fr: "Impossible d’enregistrer la méditation biblique en photo. Veuillez réessayer." },
  ...
  alreadyDone: { ko: "해당 날짜의 말씀 묵상 기록이 이미 있어요.", de: "Für dieses Datum gibt es bereits eine Stille Zeit.", en: "You already have a Bible Reflection for this date.", fr: "Vous avez déjà une méditation biblique pour cette date." },
  progressError: { ko: "말씀동행 반영에 실패했어요. 다시 완료해주세요.", de: "Die Speicherung deines Fortschritts ist fehlgeschlagen. Bitte schließe die Stille Zeit erneut ab.", en: "Your Word Walk progress could not be saved. Please complete it again.", fr: "La progression de votre cheminement n’a pas pu être enregistrée. Veuillez terminer à nouveau." },
} as const;
