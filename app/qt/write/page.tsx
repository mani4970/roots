...
const QT_WRITE_TRANSLATIONS: Record<string, Partial<Record<Lang, string>>> = {
  ...
  "느낌과 묵상": { de: "Gedanken & Erkenntnisse", en: "Thoughts & Insights", fr: "Réflexions et enseignements" },
  ...
  "붙잡은 말씀으로 묵상해요": { de: "Den Schlüsselvers vertiefen", en: "Reflect on your key verse", fr: "Réfléchir à partir du verset clé" },
  "이 말씀을 붙들고 느낌과 묵상을 적어보세요.": { de: "Halten Sie dieses Wort fest und schreiben Sie Ihre Gedanken und Erkenntnisse auf.", en: "Hold on to this verse and write down your thoughts and insights.", fr: "Appuyez-vous sur cette Parole et notez vos réflexions et les enseignements reçus." },
  ...
  "말씀동행 반영에 실패했어요. 다시 완료해주세요.": { de: "Die Speicherung deines Fortschritts ist fehlgeschlagen. Bitte schließe die Stille Zeit erneut ab.", en: "Your Word Walk progress could not be saved. Please complete it again.", fr: "La progression de votre cheminement n’a pas pu être enregistrée. Veuillez terminer à nouveau." },
  // UI 문자열
  ...
  "오늘 읽은 말씀, 느낀 점, 깨달음을 자유롭게 적어보세요...": { de: "Schreiben Sie frei über das Wort, Ihre Gedanken und Erkenntnisse...", en: "Write freely about the Word, your thoughts and insights...", fr: "Écrivez librement sur la Parole lue aujourd’hui, vos réflexions et les enseignements reçus..." },
  ...
  "자유 큐티": { de: "Freie Stille Zeit", en: "Free-form Bible Reflection", fr: "Méditation biblique libre" },
  "오늘의 묵상": { de: "Heutige Stille Zeit", en: "Today's Bible Reflection", fr: "Méditation biblique du jour" },
