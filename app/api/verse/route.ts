...
위 감정에 맞는 성경 말씀 1개와 오늘의 결단 미션을 JSON 형식으로만 답하세요. 다른 텍스트 없이 JSON만 출력하세요:
{"verse":"말씀 내용 (한국어 개역개정)","reference":"성경 책명 장:절","message":"이 말씀이 오늘 당신에게 주는 의미 (2-3문장, 따뜻한 톤)","mission":"오늘 하루 구체적으로 실천할 수 있는 결단 미션 1가지 (1-2문장, 구체적으로)"}`
      }],
    });
