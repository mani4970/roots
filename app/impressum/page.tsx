...
const COPY = {
  ko: {
    ...
    disclaimerBody:
      "서비스 제공자는 독일 DDG § 7 Abs.1에 따라 본 앱의 자체 콘텐츠에 대해 일반 법률에 따른 책임을 집니다. DDG §§ 8–10에 따라 전송되거나 저장된 외부 정보를 감시하거나 위법 행위를 나타내는 정황을 조사할 일반적인 의무는 없습니다. 일반 법률에 따른 정보 삭제 또는 차단 의무는 영향을 받지 않습니다.",
    privacyBody:
    ...
    englishBody:
      "Responsible for the content of this app pursuant to § 5 DDG (German Digital Services Act):",
    externalBody:
  ...
  en: {
    ...
    disclaimerBody:
      "As a service provider, we are responsible for our own content in accordance with § 7(1) DDG and general German law. Under §§ 8–10 DDG, we are not obliged to monitor transmitted or stored third-party information or investigate circumstances indicating unlawful activity. Obligations to remove or block the use of information under general law remain unaffected.",
    privacyBody:
  ...
  fr: {
    ...
    disclaimerBody:
      "En tant que fournisseur de services, nous sommes responsables de nos propres contenus conformément au § 7(1) DDG et au droit allemand général. Selon les §§ 8–10 DDG, nous ne sommes pas tenus de surveiller les informations de tiers transmises ou stockées ni de rechercher des circonstances indiquant une activité illicite. Les obligations de retrait ou de blocage prévues par la loi demeurent inchangées.",
    privacyBody:
