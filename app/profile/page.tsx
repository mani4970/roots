    ...
    <div className="page" style={{ paddingBottom: 80 }}>
      ...
      <div style={{ padding: "14px 16px 0" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
          {[
            { label: t("profile_prayer_count", lang), value: prayerStats.total, icon: <img src="/icon-prayer-request.webp" alt="" width={48} height={48} style={{ objectFit: "contain" }} /> },
            { label: t("profile_prayer_answered_count", lang), value: prayerStats.answered, icon: <img src="/icon-prayer-answered.webp" alt="" width={48} height={48} style={{ objectFit: "contain" }} /> },
            { label: t("profile_qt_share", lang), value: qtShareCount, icon: <img src="/icon-qt-share.webp" alt="" width={48} height={48} style={{ objectFit: "contain" }} /> },
          ].map(s => (
            <div key={s.label} className="card" style={{ textAlign: "center", padding: "14px 8px" }}>
              <div style={{ height: 48, marginBottom: 6, display: "flex", alignItems: "center", justifyContent: "center" }}>{s.icon}</div>
