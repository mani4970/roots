...
import { ESV_FULL_COPYRIGHT_NOTICE } from "@/lib/esvBible";
...
const COPY = {
  ko: {
    ...
    updated: "시행 및 최종 수정일: 2026년 8월 12일",
    sections: [
      ...
      { title: "7. 성경 본문과 지식재산권", paragraphs: ["Roots의 이름, 로고, 캐릭터, 배지, 지도, 디자인과 소프트웨어는 Roots 또는 정당한 권리자의 보호 대상입니다. 개인적인 앱 이용 외의 복제·배포·판매·수정은 허용되지 않습니다.", "성경 본문은 각 번역본의 저작권과 이용 허락 조건에 따라 제공됩니다. 적용되는 번역본별 저작권 고지는 앱의 성경 저작권 안내에 별도로 표시됩니다.", ESV_FULL_COPYRIGHT_NOTICE] },
  ...
  de: {
    ...
    updated: "Gültig und zuletzt aktualisiert am 12. August 2026",
    sections: [
      ...
      { title: "3. Private Einträge und freiwilliges Teilen", paragraphs: ["Einträge zur Stillen Zeit, Gebetsanliegen und Stille-Zeit-Einträge mit Foto sind standardmäßig privat. Roots veröffentlicht sie nicht automatisch.", "Eine Freigabe erfolgt nur, wenn Sie selbst einen Empfängerkreis wie die Community, eine Gruppe oder Glaubenspartner wählen. Sie können die Freigabe jederzeit beenden; der private Originaleintrag bleibt bestehen, bis Sie ihn löschen."] },
  ...
  en: {
    ...
    updated: "Effective and last updated: August 12, 2026",
    sections: [
      ...
      { title: "3. Private records and optional sharing", paragraphs: ["Bible Reflections, prayer requests, and Photo Bible Reflections are private by default. Roots does not publish them automatically.", "Sharing occurs only when you actively select an audience such as the community, a group, or faith partners. You may stop sharing at any time; your private original remains until you delete it."] },
      { title: "4. User content", paragraphs: ["You retain your rights in Bible Reflections, prayers, photos, profile information, and community content you create or upload.", "When you choose to share, you grant Roots only the limited, non-exclusive permission needed to store, display, and transmit the content to your selected audience. That permission ends after sharing is stopped or the content is deleted, subject to necessary technical processing time.", "You may upload only content you have the right to use and must not violate another person's privacy, copyright, image rights, or other rights."] },
  ...
  fr: {
    ...
    updated: "Entrée en vigueur et dernière mise à jour : 12 août 2026",
    sections: [
      ...
      { title: "7. Textes bibliques et propriété intellectuelle", paragraphs: ["Le nom, le logo, les personnages, badges, cartes, graphismes et logiciels de Roots sont protégés par Roots ou leurs titulaires. Leur copie, distribution, vente ou modification en dehors de l’usage personnel de l’app est interdite.", "Les textes bibliques sont fournis selon les droits d’auteur et licences de chaque traduction. Les mentions propres à chaque traduction figureront dans les informations bibliques et juridiques de l’app.", ESV_FULL_COPYRIGHT_NOTICE] },
